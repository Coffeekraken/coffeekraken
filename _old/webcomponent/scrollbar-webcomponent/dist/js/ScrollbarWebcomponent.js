...
var _getStyleProperty = _interopRequireDefault(require("@coffeekraken/sugar/js/dom/getStyleProperty"));
 ...
 */
class ScrollbarWebcomponent extends _SWebComponent.default {
  /**
   * Css
   * @protected
   */
  ...
  componentMount() {
    super.componentMount(); // init the simplebar

    this._simplebar = new _simplebar.default(this, {
      scrollbarMinSize: 0
    });
  }
...
exports.default = ScrollbarWebcomponent;

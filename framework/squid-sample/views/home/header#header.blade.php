				...
				<div class="gr gr--middle">
					...
					<div class="col col--12 col--7@tablet col--start-0 col--start-6@tablet header__content">
						<div anim="slide-in-up">
							...
							<s-bodymovin src="/data/logo-white.json" class="m-b m-t" style="display: inline-block; width:200px; height:62px" autoplay autoplay-delay="1000"></s-bodymovin>
							<h1 class="h1 m-b-smaller">
								<s-characters-slideshow class="c-secondary" values="['Workflow','Styleguide','Documentation','Layout','Webcomponents']">Coco</s-characters-slideshow><br>
								made right!
							</h1>

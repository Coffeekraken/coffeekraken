...
// require('jquery');
const interactiveDemoElm = document.querySelector('ck-interactive-demo');
...
if (savedState !== null) {
  ...
  if (state._layout === layout) {
    myLayout = new _goldenLayout.default(state, document.querySelector('ck-interactive-demo'));
  } else {
    myLayout = new _goldenLayout.default(config, document.querySelector('ck-interactive-demo'));
  }
} else {
  myLayout = new _goldenLayout.default(config, document.querySelector('ck-interactive-demo'));
}

...
if (savedState !== null) {
  ...
  if (state._layout === layout) {
    myLayout = new _goldenLayout.default(state, document.querySelector('s-interactive-demo'));
  } else {
    myLayout = new _goldenLayout.default(config, document.querySelector('s-interactive-demo'));
  }
} else {
  myLayout = new _goldenLayout.default(config, document.querySelector('s-interactive-demo'));
}

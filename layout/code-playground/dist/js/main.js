...
require('./webcomponent.imports.js'); // import SNotificationComponent from 'coffeekraken-s-notification-component/dist/class'
...
document.body.addEventListener('compileError', e => {// SNotificationComponent.notify({
  // 	type : 'error',
  // 	title : 'Woups...',
  // 	body : e.detail.error,
  // 	timeout : 20000

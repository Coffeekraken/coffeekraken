...
`,u=globalThis&&globalThis.__awaiter||function(a,t,e,s){return new(e=e||Promise)(function(i,o){function n(p){try{d(s.next(p))}catch(c){o(c)}}function l(p){try{d(s.throw(p))}catch(c){o(c)}}function d(p){var c;p.done?i(p.value):((c=p.value)instanceof e?c:new e(function(y){y(c)})).then(n,l)}d((s=s.apply(a,t||[])).next())})};class m extends _{constructor(){var t;super(b({name:"s-color-picker",interface:f})),this.state={},this._originalState={},this._hasInput=!1,this._hasButton=!1,this._isShadeInInteraction=!1,this._isAlphaInInteraction=!1,this._isHueInInteraction=!1,this.state={h:0,s:0,l:0,a:1,metasFormat:"hex",value:void 0},this._$input=this.querySelector("input"),this._hasInput=this._$input!==null,this._$button=this.querySelector("button"),(t=this._$button)!=null&&t.addEventListener("pointerup",e=>e.preventDefault()),this._hasButton=this._$button!==null}static get properties(){return _.createProperties({},f)}static get styles(){return $`
        ...
        `}mount(){return u(this,void 0,void 0,function*(){this._hueColor=new h("#000"),this._color=new h("#000")})}firstUpdated(){var t;return u(this,void 0,void 0,function*(){Object.assign(this._originalState,this.state),this._$root=this.querySelector("."+this.componentUtils.uniqueClassName("__root")),this._$picker=this.querySelector("."+this.componentUtils.uniqueClassName("__picker")),this._$colorInput=this.querySelector("."+this.componentUtils.uniqueClassName("__color-input")),this._$shade=this.querySelector("."+this.componentUtils.uniqueClassName("__shade")),this._shadeCtx=this._$shade.getContext("2d"),this._$hue=this.querySelector("."+this.componentUtils.uniqueClassName("__hue")),this._hueCtx=this._$hue.getContext("2d"),this._$alpha=this.querySelector("."+this.componentUtils.uniqueClassName("__alpha")),this._alphaCtx=this._$alpha.getContext("2d"),this._$input||(this._$input=this.querySelector("input")),(t=this._$input)!=null&&t.hasAttribute("name")||(t=this._$input)!=null&&t.setAttribute("name",this.props.name),(t=this._$input)!=null&&t.hasAttribute("placeholder")||(t=this._$input)!=null&&t.setAttribute("placeholder",this.props.placeholder),(t=this._$input)!=null&&t.hasAttribute("autocomplete")||(t=this._$input)!=null&&t.setAttribute("autocomplete","off"),this._$input.setAttribute("readonly",!0),this.addEventListener("focusin",e=>{var s;(s=this._floatApi)!=null&&s.update()}),v(this.querySelector(".s-color-picker__selectors")),v(this.querySelector(".s-color-picker__metas")),this._isAlphaWanted()||(this.state.a=1),this._initColor(),this._initHueSelector(),this._updateAlphaSelector(),this._updateShadeCanvas(),this._initSelectionInteractions(),this._restoreState(),this._updateInput("init"),this.props.inline||x()||(this._floatApi=C(this._$picker,this._$root,this.props.floatSettings))})}_initColor(){var t=(t=this.props.value)!=null?t:(t=this._$input)==null?void 0:t.value;t&&(this._inputColor=new h(t)),!this.state.value&&t?(this._color=new h(t),this._isAlphaWanted()||(this._color.a=1)):(this._color.h=this.state.h,this._color.s=this.state.s,this._color.l=this.state.l,this._color.a=this.state.a)}_updateInput(t){if(t==="init"||this.props.updateInput.includes(t)){switch(this.props.format){case"hex":this.state.value=this._color.toHexString();break;case"hexa":this.state.value=this._color.toHexaString();break;case"rgb":this.state.value=this._color.toRgbString();break;case"rgba":this.state.value=this._color.toRgbaString();break;case"hsl":this.state.value=this._color.toHslString();break;case"hsla":this.state.value=this._color.toHslaString()}this._$input&&this._$input.value!==this.state.value&&(this._$input.value=this.state.value),t!=="init"&&this.componentUtils.dispatchEvent("change",{detail:this._color.toObject()}),this.requestUpdate()}}_restoreState(){this._setAlpha(this._color.a),this._setHue(this._color.h),this._setShade(this._color.s,this._color.l)}_setMetasFormat(t){return this.state.metasFormat=t,this.requestUpdate(),!1}_validate(){var t,e;this._updateInput("validate"),(e=(t=document.activeElement)==null?void 0:t.blur)!=null&&e.call(t)}_clear(){this._inputColor?(this._setAlpha(this._inputColor.a),this._setHue(this._inputColor.h),this._setShade(this._inputColor.s,this._inputColor.l)):(this._setAlpha(1),this._setHue(0),this._setShade(0,0)),this._updateInput("clear")}_reset(){this._setAlpha(this._originalState.a),this._setHue(this._originalState.h),this._setShade(this._originalState.s,this._originalState.l),this._updateInput("reset")}_isAlphaWanted(){return this.props.format.includes("a")}_initSelectionInteractions(){let t=!1,e=(this._$shade.addEventListener("pointerdown",s=>{t=!0,this._isShadeInInteraction=!0,this._$shade.setPointerCapture(s.pointerId),this._setShadeFromEvent(s,!1),this._updateInput("pointerdown"),this.requestUpdate()}),this._$shade.addEventListener("pointermove",s=>{s.preventDefault(),t&&(this._setShadeFromEvent(s,!1),this._updateInput("pointermove"))}),this._$shade.addEventListener("pointerup",s=>{t=!1,this._isShadeInInteraction=!1,this._$shade.releasePointerCapture(s.pointerId),this._setShadeFromEvent(s,!0),this._updateInput("pointerup"),this.requestUpdate()}),!1);this._$alpha.addEventListener("pointerdown",s=>{e=!0,this._isAlphaInInteraction=!0,this._$alpha.setPointerCapture(s.pointerId),this._setAlphaFromEvent(s,!1),this._updateInput("pointerdown"),this.requestUpdate()}),this._$alpha.addEventListener("pointermove",s=>{s.preventDefault(),e&&(this._setAlphaFromEvent(s,!1),this._updateInput("pointermove"))}),this._$alpha.addEventListener("pointerup",s=>{e=!1,this._isAlphaInInteraction=!1,this._$alpha.releasePointerCapture(s.pointerId),this._setAlphaFromEvent(s,!0),this._updateInput("pointerup"),this.requestUpdate()})}_setHueFromEvent(s,e=!0){var i=s.target.getBoundingClientRect(),s=s.clientY-i.top,i=100-Math.round(100/i.height*s);let o=360-Math.round(3.6*i);360<(o=o<0?0:o)&&(o=360),this._setHue(o,e)}_setHue(t,e=!0){e&&(this.state.h=t),this._color.h=t,this.style.setProperty("--s-color-picker-h",t),this._updateShadeCanvas(),this._updateAlphaSelector(),this.requestUpdate()}_setShadeFromEvent(o,e=!0){var s=o.target.getBoundingClientRect(),i=o.clientY-s.top,o=o.clientX-s.left;let n=100-Math.round(100/s.height*i),l=Math.round(100/s.width*o);100<(n=n<0?0:n)&&(n=100),100<(l=l<0?0:l)&&(l=100),this._setShade(l,.5*n,e)}_setShade(t,e,s=!0){var i=e+(100-t)/2,o=(i*=2*e/100,t);s&&(this.state.s=o,this.state.l=i),this._color.s=o,this._color.l=i,this.style.setProperty("--s-color-picker-shade-x",t),this.style.setProperty("--s-color-picker-shade-y",100<2*e?100:2*e),this.style.setProperty("--s-color-picker-s",o),this.style.setProperty("--s-color-picker-l",i),this._updateShadeCanvas(),this.requestUpdate()}_setAlphaFromEvent(i,e=!0){var s=i.target.getBoundingClientRect(),i=i.clientY-s.top;let o=100-Math.round(100/s.height*i);100<(o=o<0?0:o)&&(o=100),this._setAlpha(o/100,e)}_setAlpha(t,e=!0){e&&(this.state.a=t),this._color.a=t,this.style.setProperty("--s-color-picker-a",t),this._updateAlphaSelector(),this.requestUpdate()}_copy(){const t=this.props.copyIconClass;this.props.copyIconClass=this.props.copiedIconClass,w(this._$colorInput.value),setTimeout(()=>{this.props.copyIconClass=t},1e3)}_eyeDropper(){return u(this,void 0,void 0,function*(){var e=yield new EyeDropper().open();e.sRGBHex&&(e=new h(e.sRGBHex),this._setAlpha(1),this._setHue(e.h),this._setShade(e.s,e.l),this._updateInput("eyedropper"))})}_initHueSelector(){var t=this._$hue.getBoundingClientRect();this._hueCtx.canvas.width=t.width,this._hueCtx.canvas.height=t.height;const e=this._hueCtx.createLinearGradient(0,0,0,t.height);e.addColorStop(0,"rgb(255, 0, 0)"),e.addColorStop(1/6,"rgb(255, 255, 0)"),e.addColorStop(2/6,"rgb(0, 255, 0)"),e.addColorStop(.5,"rgb(0, 255, 255)"),e.addColorStop(4/6,"rgb(0, 0, 255)"),e.addColorStop(5/6,"rgb(255, 0, 255)"),e.addColorStop(1,"rgb(255, 0, 0)"),this._hueCtx.fillStyle=e,this._hueCtx.fillRect(0,0,3*t.width,t.height);let s=!1;this._$hue.addEventListener("pointerdown",i=>{s=!0,this._isHueInInteraction=!0,this.requestUpdate(),this._$hue.setPointerCapture(i.pointerId),this._setHueFromEvent(i,!1),this._updateInput("pointerdown")}),this._$hue.addEventListener("pointermove",i=>{i.preventDefault(),s&&(this._setHueFromEvent(i),this._updateInput("pointermove",!1))}),this._$hue.addEventListener("pointerup",i=>{s=!1,this._isHueInInteraction=!1,this.requestUpdate(),this._$hue.releasePointerCapture(i.pointerId),this._setHueFromEvent(i,!0),this._updateInput("pointerup",!0)})}_updateAlphaSelector(){var t=this._$alpha.getBoundingClientRect();this._alphaCtx.canvas.width=t.width,this._alphaCtx.canvas.height=t.height;const e=this._alphaCtx.createLinearGradient(0,0,0,t.height);e.addColorStop(0,`rgba(${this._hueColor.r}, ${this._hueColor.g}, ${this._hueColor.b}, 1)`),e.addColorStop(1,`rgba(${this._hueColor.r}, ${this._hueColor.g}, ${this._hueColor.b}, 0)`),this._alphaCtx.fillStyle=e,this._alphaCtx.fillRect(0,0,3*t.width,t.height)}_updateShadeCanvas(){let t=this._shadeCtx.createLinearGradient(0,0,this._shadeCtx.canvas.width,0);const e=this._color.clone(),s=(e.s=100,e.l=50,t.addColorStop(0,"#fff"),t.addColorStop(1,e.toHex()),this._shadeCtx.fillStyle=t,this._shadeCtx.fillRect(0,0,this._shadeCtx.canvas.width,this._shadeCtx.canvas.height),this._shadeCtx.createLinearGradient(0,0,0,this._shadeCtx.canvas.height));s.addColorStop(0,"rgba(0,0,0,0)"),s.addColorStop(1,"#000"),this._shadeCtx.fillStyle=s,this._shadeCtx.fillRect(0,0,this._shadeCtx.canvas.width,this._shadeCtx.canvas.height)}render(){var t;return r`
            ...
            >
                ${this._hasInput||this.props.input?"":r`
                          <input
                ...
                >
                    ${!this._hasInput&&this.props.input?r`
                              ...
                              />
                          `:(this._hasInput,"")}
                    ${!this._hasButton&&this.props.button?r`
                              <button
                                  ?disabled=${this.props.disabled}
                                  onclick="return false"
                                  class="${this.componentUtils.className("__button","s-btn")}"
                              >
                                  ${this.props.buttonIconClass?r`
                                            <i
                ...
                >
                    ...
                    ${this.props.actions.length?r`
                              <div
                                  class="${this.componentUtils.className("__actions")}"
                              >
                                  ${this.props.actions.includes("clear")?r`
                                            <button
                                        ...
                                        `:""}
                                  ${this.props.actions.includes("reset")?r`
                                            <button
                                        ...
                                        `:""}
                                  ${this.props.actions.includes("validate")?r`
                                            <button
        ...
        `}}function N(a={},t="s-color-picker"){m.define(m,a,t)}export{N as default};

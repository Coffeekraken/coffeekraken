        ...
        return html`
            <div class="ck-ratings">
                ...
                <p class="s-typo:lead s-mbe:50">
                    Want to show your love to the community? Don't hesitate to
                    let a comment on your experience using Coffeekraken. We are
                ...
                ${this.state.state === 'write'
                    ? html`
                          ...
                          >
                              ...
                              <button
                                  ...
                                  @click=${() => this._signInWithGoogle()}
                              >
                                  <i class="s-icon:github s-mie:10"></i> Sign in
                                  with Github
                              </button>
                              <div class="s-flex-item:grow">
                    ...
                    ? html`
                          ...
                          <p class="s-typo:p s-mbe:30" s-appear in="bottom">
                              Your support is really important for us. Thank's
                              again to have taking time give us your thoughts!
                          </p>

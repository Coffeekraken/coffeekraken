import { m as __traverseUp, n as SPromise, S as SInterface, j as SLitComponent, k as css, u as unsafeCSS, _ as __deepMerge, o as __uniqid, p as isClass, i as __querySelectorLive, l as html } from "./index-24861f6a.js";
import { _ as __querySelectorUp } from "./querySelectorUp-1cdd9caf.js";
...
line-height: 1.8;
max-width: 55ch;
color: hsla(calc(var(--s-theme-color-main-h, 0) + var(--s-theme-color-main-text-spin ,0)),calc((var(--s-theme-color-main-s, 0) + var(--s-theme-color-main-text-saturation-offset, 0)) * 1%),calc((var(--s-theme-color-main-l, 0) + var(--s-theme-color-main-text-lightness-offset, 0)) * 1%),0.7);
    max-width: 100%;
}

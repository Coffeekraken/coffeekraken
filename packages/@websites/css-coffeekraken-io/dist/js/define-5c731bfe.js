import { m as __traverseUp, n as SPromise, S as SInterface, j as SLitComponent, k as css, u as unsafeCSS, _ as __deepMerge, o as __uniqid, p as isClass, i as __querySelectorLive, l as html } from "./index-1ed0cb73.js";
...
const __css = `.sMj {
    display: block;
    font-size: calc(1rem * var(--sB, 1) * var(--sC, 1));
    --spc: 20px;
}
    ...
    .sMj[direction='vertical'][pad] > .sMk > .sMl > .sbmU > .sbmW {
                    height: var(--sbmQ, 0);
                }

    .sMj[direction='vertical'][pad] > .sMk > .sMl > .sbmU > .sbmX {
                    height: var(--sbmR, 0);
                }

    .sMj[direction='horizontal'][pad] > .sMk > .sMl > .sbmU > .sbmW {
                    width: var(--sbmQ, 0);
                }

    .sMj[direction='horizontal'][pad] > .sMk > .sMl > .sbmU > .sbmX {
                    width: var(--sbmR, 0);
                }
...
.sbm0 {
    ...
    left: 0;
    width: 100%;
    background: hsla(calc(var(--sP, 0) + var(--sba ,0)),calc((var(--sR, 0) + var(--sbb, 0)) * 1%),calc((var(--sT, 0) + var(--sbc, 0)) * 1%),0.3);
    padding: calc(calc(var(--s0, 1rem) * var(--sB, 1) * var(--sC, 1)) * 3.25);
    display: flex;
    flex-direction: column;
    gap: calc(var(--sk, 1rem) * 1.5);
}

.sbm1 {display: block;font-family: var(--siZ, "Roboto"); 
 font-weight: var(--si0, 500);font-size: calc(var(--sbt, 15px) * calc(var(--sjm, 3) * var(--sB, 1) * var(--sC, 1)));
line-height: 1.3;
max-width: 55ch;
}
...
.sbm1 {font-size: calc(var(--sbt, 15px) * calc(var(--sjl, 2.5) * var(--sB, 1) * var(--sC, 1)));
}
}

.sbm1 {
    color: hsla(calc(var(--sV, 0) + var(--sW ,0)),calc((var(--sX, 0)) * 1%),calc((var(--sY, 0)) * 1%),var(--sZ, 1));
}

.sbm2 {display: block;font-family: var(--sbr, "Roboto"); 
 font-weight: var(--sbs, 400);font-size: calc(var(--sbt, 15px) * calc(var(--sji, 1.25) * var(--sB, 1) * var(--sC, 1)));
line-height: 1.6;
max-width: 55ch;
}
...
.sbm2 {font-size: calc(var(--sbt, 15px) * calc(var(--sji, 1.25) * var(--sB, 1) * var(--sC, 1)));
}
}
...
.sbm3 {display: block;font-family: var(--sbr, "Roboto"); 
 font-weight: var(--sbs, 400);font-size: calc(var(--sbt, 15px) * calc(var(--sbu, 1.1) * var(--sB, 1) * var(--sC, 1)));
line-height: 1.8;
max-width: 55ch;
color: hsla(calc(var(--sP, 0) + var(--sbv ,0)),calc((var(--sR, 0) + var(--sbw, 0)) * 1%),calc((var(--sT, 0) + var(--sbx, 0)) * 1%),0.7);
    max-width: 100%;
}

.sMj[behavior='scroll'] > .sMk > .sMl {
            overflow: auto;
            overflow-y: hidden;
...
.sMj[behavior='scroll'] > .sMk > .sMl::-webkit-scrollbar {
                display: none;
            }

.sMj[behavior='scroll'] > .sMk > .sMl > .sbmU > .sbmV {
                    scroll-snap-align: center;
                }

.sMj[behavior='scroll'][direction='vertical'] > .sMk > .sMl {
                overflow-x: hidden;
                overflow-y: auto;
...
.sMj[lnf^='default']:not([class*='s-ratio']) {
        aspect-ratio: 16/9;
    }

.sMj[lnf^='default']:not([mounted]) {
        opacity: 0;
    }
...
.sMj[lnf^='default'][pad] > .sMk > .sMl > .sbmU > .sbm4 {
                    flex-shrink: 0;
                    flex-grow: 0;
                }
...
.sMj[lnf^='default'] > .sMk > .sMl > .sbmU > .sbmV {
                    display: block;
                    flex-shrink: 0;
                    flex-grow: 0;
                    width: 100%;
...
.sMj[lnf^='default'] > .sMk > .sMm > .sMn {
                position: absolute;
                top: calc(100% + var(--spc));
                left: 50%;
                transform: translate(-50%);
                display: flex;
                gap: calc(var(--spc) * 0.5);
            }
...
.sMj[lnf^='default'] > .sMk > .sMm > .sMn > *:hover {
                        opacity: 0.5;
                    }

.sMj[lnf^='default'] > .sMk > .sMm > .sMn > *.sbI {
                        opacity: 1;
                    }

.sMj[lnf^='default'][direction='vertical']
        > .sMk
        > .sMl
        > .sbmU {
        display: block;
...
.sMj[lnf^='default'][lnf$='-contain'] .sMk > .sMm > .sMn {
        top: auto;
        bottom: calc(var(--spc) - 0.5em);
        transform: translate(-50%, -100%);
    }

.sMj[lnf^='default'][direction='vertical'] .sMk > .sMm > .sMn {
        top: 50%;
...
.sMj[lnf^='default'][lnf$='-contain'][direction='vertical']
        .sMk
        > .sMm
        > .sMn {
        bottom: auto;
...
.sMj[lnf^='default'][lnf$='-tight'][direction='horizontal'][controls] {
        padding-left: calc(var(--spc) + 1em);
        padding-right: calc(var(--spc) + 1em);
    }

.sMj[lnf^='default'][lnf$='-tight'][direction='horizontal'][nav] {
        padding-bottom: calc(var(--spc) + 1em);
    }

.sMj[lnf^='default'][lnf$='-tight'][direction='vertical'][controls] {
        padding-top: calc(var(--spc) + 1em);
        padding-bottom: calc(var(--spc) + 1em);
    }

.sMj[lnf^='default'][lnf$='-tight'][direction='vertical'][nav] {
        padding-right: calc(var(--spc) + 1em);
    }

.sMj[lnf^='default'] > .sMk > .sMm > .sMo {
        position: absolute;
        bottom: var(--spc);
        left: var(--spc);
        right: var(--spc);
...
.sMj[lnf^='default'] > .sMk > .sMm > .sMo:before {
            content: '';
            display: block;
            position: absolute;
            top: 0;
...
.sMj[lnf^='default'] > .sMk > .sMm > .sMo > .sMp {
            position: absolute;
            top: 0;
            left: 0;
            height: 100%;
...
.sMj[lnf^='default'][lnf$='-contain'] .sMk > .sMm > .sMo {
        bottom: calc(var(--spc) * 2);
    }

.sMj[lnf^='default'] > .sMk > .sMm > .sMq .sMt,
        .sMj[lnf^='default'] > .sMk > .sMm > .sMq .sMu {
            width: 1em;
            height: 1em;
            position: absolute;
            top: 50%;
...
.sMj[lnf^='default'] > .sMk > .sMm > .sMq .sMt.sbI, .sMj[lnf^='default'] > .sMk > .sMm > .sMq .sMu.sbI {
                pointer-events: all;
                opacity: 1;
            }
...
.sMj[lnf^='default'][lnf$='-contight'] > .sMk
            > .sMm
            > .sMq
            .sMu, .sMj[lnf^='default'][lnf$='-contain'] > .sMk
            > .sMm
            > .sMq
            .sMu {
            left: var(--spc);
...
.sMj[lnf^='default'][lnf$='-contight'] > .sMk
            > .sMm
            > .sMq
            .sMt, .sMj[lnf^='default'][lnf$='-contain'] > .sMk
            > .sMm
            > .sMq
            .sMt {
            left: auto;
...
.sMj[lnf^='default'][direction='vertical']
        ...
        .sMu {
        left: 50%;
        bottom: calc(100% + var(--spc));
        top: auto;
        transform: translate(-50%, 0) rotate(90deg);
    }

.sMj[lnf^='default'][direction='vertical'][lnf$='-contight'] > .sMk
            > .sMm
            > .sMq
            .sMu, .sMj[lnf^='default'][direction='vertical'][lnf$='-contain'] > .sMk
            > .sMm
            > .sMq
            .sMu {
            top: calc(var(--spc));
...
.sMj[lnf^='default'][direction='vertical'][lnf$='-contight'] > .sMk
            > .sMm
            > .sMq
            .sMt, .sMj[lnf^='default'][direction='vertical'][lnf$='-contain'] > .sMk
            > .sMm
            > .sMq
            .sMt {
            top: auto;
...
.sMj[lnf^='default'] > .sMk
        > .sMm
        > .sMq
        .sMr:before, .sMj[lnf^='default'] > .sMk
        > .sMm
        > .sMq
        .sMs:before {

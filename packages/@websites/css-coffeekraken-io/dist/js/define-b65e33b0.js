import { S as SInterface, a as SFeature, _ as __deepMerge, b as __makeFloat } from "./index-1ed0cb73.js";
...
const __css = `.s6w {
    ...
    .s6w .s5c {
        position: absolute;
        background: hsla(calc(var(--scc, 0) + var(--skQ ,0)),calc((var(--scd, 0)) * 1%),calc((var(--sce, 0)) * 1%),var(--scf, 1));
        width: var(--s6v, 8px);
        height: var(--s6v, 8px);

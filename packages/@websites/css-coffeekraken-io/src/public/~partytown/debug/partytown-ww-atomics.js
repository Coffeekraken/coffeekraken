                ...
                try {
                    ...
                    logWorker(
                        `Set ${getTargetProp(
                            target,
                            applyPath,
                        )}, value: ${getLogValue(applyPath, value)}${
                            restrictedToWorker ? ' (restricted to worker)' : ''
                        }`,
                        target[WinIdKey],
                    );
    ...
    const receiveMessageFromSandboxToWorker = (ev) => {
        ...
        if (webWorkerCtx.$isInitialized$) {
            ...
            ((initWebWorkerData) => {
                ...
                webWorkerlocalStorage.set(
                    locOrigin,
                    initWebWorkerData.$localStorage$,
                );

        ...
        <div s-floating placement="left" class="s-bare s-tooltip:interactive s-text:center">
            <div class="s-position:relative">
                ...
                <a class="s-btn s-color:complementary s-display:block"
                    ...
                    <i class="s-icon:discord s-mie:10"></i> Talk about it on Discord
                </a>
            </div>
        </div>
    </div>
        ...
        <div s-floating placement="left" class="s-bare s-tooltip:interactive s-text:center">
            <div class="s-position:relative">
                ...
                <a class="s-btn s-color:complementary s-display:block"
                    ...
                    target="_blank">
                    <i class="s-icon:discord s-mie:10"></i> Join us on discord!
                </a>
            </div>
        </div>
    </div>
        ...
        <div s-floating placement="left" class="s-bare s-tooltip:interactive s-text:center">
            <div class="s-position:relative">
                ...
                <a class="s-btn s-color:accent s-display:block" href="https://github.com/Coffeekraken/coffeekraken"
                    ...
                    <i class="s-icon:github s-mie:10"></i> Discover our codebase!
                </a>
            </div>
        </div>
    </div>

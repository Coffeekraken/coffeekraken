<section id="homepage-welcome">
    ...
    <div class="_illustration">
        <div class="_01-1">
            ...
            <div class="_line">&nbsp;&nbsp;&nbsp;<span class="s-tc:info">display</span>: <span class="s-tc:complementary">none</span>;</div>
            <div class="_line">}</div>
        </div>
        <div class="_01-2">
            <div class="_line"><span class="s-tc:accent">@sugar.media</span> <span class="s-tc:error">mobile</span> {</div>
        ...
        <div class="_02">
            <div class="_line"><span class="s-tc:accent">@sugar.depth</span> (<span class="s-tc:error">100</span>);</div>
        </div>
        <div class="_03">
            <div class="_line"><span class="s-tc:accent">@sugar.border.radius</span>;</div>
        </div>
        <div class="_04">
            <div class="_line">

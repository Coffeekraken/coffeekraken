...
<dl>
        ...
        <header class="s-flex s-bg s-bg--main-surface s-radius">
            ...
            <div class="s-typo s-typo--code">/carpenter.json</div>
        </div>
                <p class="s-typo s-typo--p s-p s-p--30">Specify a url from where to get the carpenter data back, directly the JSON data or a simple id pointing to a HTMLTemplate tag that host the JSON data</p>
    </dt>
        <dt class="s-font s-font--40 s-mbe s-mbe--30">
        <header class="s-flex s-bg s-bg--main-surface s-radius">
            <div class="s-flex-item s-flex-item--grow s-tc s-tc--accent s-p s-p--30 s-typo s-typo--strong">
            ...
            <div class="s-typo s-typo--bold s-p s-p--30 s-tc s-tc--info"></div>
                ...
                <div class="s-pi s-pi--30 s-mbs s-mbs--40">
            <div class="s-typo s-typo--code">ajax</div>
        </div>
                <p class="s-typo s-typo--p s-p s-p--30">Specify the adapter to use in order to apply the updated properties on a component/section/etc... Must be a registered adapter id</p>
    </dt>
        <dt class="s-font s-font--40 s-mbe s-mbe--30">
        <header class="s-flex s-bg s-bg--main-surface s-radius">
            <div class="s-flex-item s-flex-item--grow s-tc s-tc--accent s-p s-p--30 s-typo s-typo--strong">
            ...
            <div class="s-typo s-typo--bold s-p s-p--30 s-tc s-tc--info"></div>
                ...
                <p class="s-typo s-typo--p s-p s-p--30">Specify if you want the left sidebar to jump across all the components/sections/etc...</p>
    </dt>
        <dt class="s-font s-font--40 s-mbe s-mbe--30">
        <header class="s-flex s-bg s-bg--main-surface s-radius">
            <div class="s-flex-item s-flex-item--grow s-tc s-tc--accent s-p s-p--30 s-typo s-typo--strong">
            ...
            <div class="s-typo s-typo--bold s-p s-p--30 s-tc s-tc--info"></div>
                ...
                <div class="s-pi s-pi--30 s-mbs s-mbs--40">
            <div class="s-typo s-typo--code">/carpenter/%dotpath</div>
        </div>
                <p class="s-typo s-typo--p s-p s-p--30">Specify the link to use to change page. You have access to the %dotpath token that will be replaced by the actual component/section specs dotpath</p>
    </dt>
        <dt class="s-font s-font--40 s-mbe s-mbe--30">
        <header class="s-flex s-bg s-bg--main-surface s-radius">
            <div class="s-flex-item s-flex-item--grow s-tc s-tc--accent s-p s-p--30 s-typo s-typo--strong">
            ...
            <div class="s-typo s-typo--bold s-p s-p--30 s-tc s-tc--info"></div>
                ...
                <p class="s-typo s-typo--p s-p s-p--30">Specify if you want to put the page content inside an iframe to allow responsive resizing of your viewport. Can be either a boolean in which an iframe will be created automatically, or an iframe id to use</p>
    </dt>
        <dt class="s-font s-font--40 s-mbe s-mbe--30">
        <header class="s-flex s-bg s-bg--main-surface s-radius">
            <div class="s-flex-item s-flex-item--grow s-tc s-tc--accent s-p s-p--30 s-typo s-typo--strong">
            ...
            <div class="s-typo s-typo--bold s-p s-p--30 s-tc s-tc--info"></div>
                ...
                <div class="s-pi s-pi--30 s-mbs s-mbs--40">
            <div class="s-typo s-typo--code">&lt;svg class=&quot;logo&quot; viewBox=&quot;0 0 1166 276&quot; fill=&quot;none&quot; xmlns=&quot;http://www.w3.org/2000/svg&quot;&gt;
                ...
                <p class="s-typo s-typo--p s-p s-p--30">Specify an image to be used as logo on top left of the interface</p>
    </dt>
        <dt class="s-font s-font--40 s-mbe s-mbe--30">
        <header class="s-flex s-bg s-bg--main-surface s-radius">
            <div class="s-flex-item s-flex-item--grow s-tc s-tc--accent s-p s-p--30 s-typo s-typo--strong">
...
Array</div>
                ...
                <p class="s-typo s-typo--p s-p s-p--30">Specify some icons html to be used across the UI</p>
    </dt>
    </dl>

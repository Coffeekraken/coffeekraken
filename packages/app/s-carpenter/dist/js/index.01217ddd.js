...
class SStateFsAdapter {
  ...
  _init() {
    ...
    return __awaiter$b(this, void 0, void 0, function* () {
      const _packageTmpDir = (yield __vitePreload(() => import("./packageTmpDir.e3de5877.js"), true ? [] : void 0)).default;
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (let [prop, obj2] of Object.entries(properties2)) {
        Object.defineProperty(this.props, prop, {
          enumerable: true,
          get() {
            if (_this[prop].value && typeof _this[prop].value === "string") {
              try {
                _this[prop] = JSON.parse(_this[prop].value);
              } catch (e) {
              }
            }
            console.log("GET", prop, _this[prop]);
            return _this[prop];
          },
          set(value) {
            _this[prop] = value;

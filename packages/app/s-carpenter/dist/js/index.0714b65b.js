...
class SStateFsAdapter {
  ...
  _init() {
    ...
    return __awaiter$b(this, void 0, void 0, function* () {
      const _packageTmpDir = (yield __vitePreload(() => import("./packageTmpDir.10c718a5.js"), true ? [] : void 0)).default;
...
class SCarpenterComponent extends SLitComponent {
  constructor() {
    ...
    (async () => {
      this.state.specs = this._fetchSpecs(document.location.pathname.slice(1));
    })();
  }
  static get properties() {
    ...
    return html`
            ...
            >
                ${this.state.specs ? html`
                    <s-specs-editor .specs=${this.state.specs}></s-specs-editor>
                ` : ""}
            </div>
        `;
  }

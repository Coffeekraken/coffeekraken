...
var decycle_1;
const isArray$4 = (e) => Array.isArray(e), isObject$4 = (e) => "Object" === Object.prototype.toString.call(e).slice(8, -1), validate$1 = (e) => {
  if (void 0 === e)
    throw new Error("This method requires one parameter");
  if (!isArray$4(e) && !isObject$4(e))
  ...
  const a = (e2, c = "$") => {
    ...
    return s ? { $ref: s } : isArray$4(e2) || isObject$4(e2) ? (r[c] = e2, isArray$4(e2) ? e2.map((e3, r2) => a(e3, `${c}[${r2}]`)) : Object.keys(e2).reduce((r2, s2) => (r2[s2] = a(e2[s2], `${c}.${s2}`), r2), {})) : e2;
  };
  return a(e);
};
decycle_1 = decycle;
...
var defineProperty$2 = function(object, name2, value, predicate) {
  if (name2 in object && (!isFunction$1(predicate) || !predicate())) {
    return;
  }
...
var implementation$8 = function getName() {
  ...
  var match2 = $stringMatch(str, regex);
  ...
  while (i2 < l) {
    ...
    switch (c) {
      ...
      case "|":
        ...
        break;
      case "{":
        var rs = /^(\d+)(,(\d+)?)?\}/.exec(str.slice(i2)), min, max2;
        if (rs !== null) {
          if (last.length === 0) {
            repeatErr(i2);
          }
...
class SStateFsAdapter {
  ...
  _init() {
    ...
    return __awaiter$b(this, void 0, void 0, function* () {
      const _packageTmpDir = (yield __vitePreload(() => import("./packageTmpDir.f8321f0f.js"), true ? [] : void 0)).default;
...
var assign$1 = requireIsImplemented$5()() ? Object.assign : requireShim$2();
var isValue$1 = isValue$4;
var map = { function: true, object: true };
var isObject = function(value) {
  return isValue$1(value) && map[typeof value] || false;
};
(function(module) {
  var assign2 = assign$1, isObject$12 = isObject, isValue2 = isValue$4, captureStackTrace = Error.captureStackTrace;
...
function requireIs$4() {
  ...
  is$4 = function(value) {
    return value !== _undefined2 && value !== null;
  };
  return is$4;
}
var is$3;
...
function requireContains() {
  ...
  contains$1 = requireIsImplemented$3()() ? String.prototype.contains : requireShim$1();
  return contains$1;
}
var isValue = requireIs$4(), isPlainFunction = requireIs(), assign = assign$1, normalizeOpts = normalizeOptions, contains = requireContains();
...
class SLitComponent extends LitElement {
  constructor(settings = {}) {
    ...
    const nodeFirstUpdated = (_a3 = this.firstUpdated) === null || _a3 === void 0 ? void 0 : _a3.bind(this);
    ...
    const nodeShouldUpdate = (_b2 = this.shouldUpdate) === null || _b2 === void 0 ? void 0 : _b2.bind(this);
    this.shouldUpdate = () => {
      if (nodeShouldUpdate) {
    ...
    this.componentUtils = new SComponentUtils(this, Object.assign(Object.assign(Object.assign({}, (_c2 = this.settings) !== null && _c2 !== void 0 ? _c2 : {}), (_d2 = this.settings.componentUtils) !== null && _d2 !== void 0 ? _d2 : {}), { style: (_j = (_g = (_f = (_e = this.constructor.styles) === null || _e === void 0 ? void 0 : _e.cssText) !== null && _f !== void 0 ? _f : this.settings.style) !== null && _g !== void 0 ? _g : (_h = this.settings.componentUtils) === null || _h === void 0 ? void 0 : _h.style) !== null && _j !== void 0 ? _j : "" }));
  ...
  static propertiesFromInterface(properties2, int) {
    ...
    Object.keys(SLitComponentPropsInterface.definition).forEach((prop) => {
      ...
      if (definition.physical || ((_e = (_d2 = definition.type) === null || _d2 === void 0 ? void 0 : _d2.toLowerCase) === null || _e === void 0 ? void 0 : _e.call(_d2)) === "boolean" || ((_h = (_g = (_f = definition.type) === null || _f === void 0 ? void 0 : _f.type) === null || _g === void 0 ? void 0 : _g.toLowerCase) === null || _h === void 0 ? void 0 : _h.call(_g)) === "boolean") {
...
class SCarpenterComponent extends SLitComponent {
  constructor() {
    ...
    (async () => {
      this.state.specs = this._fetchSpecs(

...
class SStateFsAdapter {
  ...
  _init() {
    ...
    return __awaiter$b(this, void 0, void 0, function* () {
      const _packageTmpDir = (yield __vitePreload(() => import("./packageTmpDir.56e50efc.js"), true ? [] : void 0)).default;
  ...
  render() {
    return html`
            <nav class="__navigation">
                ${this.state.global ? html`
                          <ul class="s-fs-tree">
                              ${Object.keys(
      this.state.global.specsBySources
    ).map((sourceId) => {
      var _a3;
      const sourceObj = this.state.global.specsBySources[sourceId];
      console.log("SOU", sourceObj);
      return html`
                                      <li class="active">
                                          <div>

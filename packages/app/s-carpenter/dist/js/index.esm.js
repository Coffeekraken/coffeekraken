...
var decycle_1;
const isArray$5 = (e) => Array.isArray(e), isObject$5 = (e) => "Object" === Object.prototype.toString.call(e).slice(8, -1), validate = (e) => {
  if (void 0 === e)
  ...
  const a2 = (e2, c = "$") => {
    ...
    return s ? { $ref: s } : isArray$5(e2) || isObject$5(e2) ? (r[c] = e2, isArray$5(e2) ? e2.map((e3, r2) => a2(e3, `${c}[${r2}]`)) : Object.keys(e2).reduce((r2, s2) => (r2[s2] = a2(e2[s2], `${c}.${s2}`), r2), {})) : e2;
  };
  return a2(e);
};
decycle_1 = decycle;
...
var stringToPath = function stringToPath2(string2) {
  ...
  var result2 = [];
  $replace$1(string2, rePropName, function(match2, number, quote2, subString) {
...
var isDateObject = function isDateObject2(value) {
  ...
  return hasToStringTag$8 ? tryDateObject(value) : toStr$9.call(value) === dateClass;
};
...
var isNumberObject = function isNumberObject2(value) {
  ...
  return hasToStringTag$6 ? tryNumberObject(value) : toStr$7.call(value) === numClass;
};
...
var isRegex$1 = hasToStringTag$5 ? function isRegex2(value) {
  ...
  var hasLastIndexDataProperty = descriptor2 && has$3(descriptor2, "value");
...
var objectInspect = function inspect_(obj2, options, depth, seen2) {
  ...
  if (isError$1(obj2)) {
    ...
    if (!("cause" in Error.prototype) && "cause" in obj2 && !isEnumerable.call(obj2, "cause")) {
      return "{ [" + String(obj2) + "] " + $join.call($concat.call("[cause]: " + inspect2(obj2.cause), parts), ", ") + " }";
    }
    if (parts.length === 0) {
      return "[" + String(obj2) + "]";
    }
  ...
  if (!isDate$2(obj2) && !isRegExp$1(obj2)) {
    ...
    var stringTag = !isPlainObject3 && toStringTag$1 && Object(obj2) === obj2 && toStringTag$1 in obj2 ? $slice$1.call(toStr$4(obj2), 8, -1) : protoTag ? "Object" : "";
...
function isArray$4(obj2) {
  return toStr$4(obj2) === "[object Array]" && (!toStringTag$1 || !(typeof obj2 === "object" && toStringTag$1 in obj2));
}
function isDate$2(obj2) {
  return toStr$4(obj2) === "[object Date]" && (!toStringTag$1 || !(typeof obj2 === "object" && toStringTag$1 in obj2));
}
function isRegExp$1(obj2) {
  return toStr$4(obj2) === "[object RegExp]" && (!toStringTag$1 || !(typeof obj2 === "object" && toStringTag$1 in obj2));
}
function isError$1(obj2) {
  return toStr$4(obj2) === "[object Error]" && (!toStringTag$1 || !(typeof obj2 === "object" && toStringTag$1 in obj2));
}
function isString$4(obj2) {
  return toStr$4(obj2) === "[object String]" && (!toStringTag$1 || !(typeof obj2 === "object" && toStringTag$1 in obj2));
}
function isNumber$1(obj2) {
  return toStr$4(obj2) === "[object Number]" && (!toStringTag$1 || !(typeof obj2 === "object" && toStringTag$1 in obj2));
}
function isBoolean$1(obj2) {
  return toStr$4(obj2) === "[object Boolean]" && (!toStringTag$1 || !(typeof obj2 === "object" && toStringTag$1 in obj2));
}
...
function inspectString(str2, opts) {
  if (str2.length > opts.maxStringLength) {
    ...
    return inspectString($slice$1.call(str2, 0, opts.maxStringLength), opts) + trailer;
  }
...
var sideChannel = function getSideChannel() {
  ...
  var channel2 = {
    assert: function(key) {
      if (!channel2.has(key)) {
        throw new $TypeError$4("Side channel does not contain " + inspect(key));
      }
    },
    get: function(key) {
  ...
  while (i < l) {
    ...
    switch (c) {
      ...
      case "|":
        ...
        break;
      case "{":
        var rs = /^(\d+)(,(\d+)?)?\}/.exec(str2.slice(i)), min, max2;
        if (rs !== null) {
          if (last.length === 0) {
            repeatErr(i);
          }
...
class SEventEmitter$1 extends SClass {
  ...
  static pipe(sourceSEventEmitter, destSEventEmitter, settings) {
    ...
    sourceSEventEmitter.on(set.events || "*", (value, metas) => __awaiter$g(this, void 0, void 0, function* () {
...
class SPromise extends SClass.extends(Promise) {
  static queue(promises, before, after) {
    return new SPromise(({ resolve, reject, pipe }) => __awaiter$f(this, void 0, void 0, function* () {
      const results = {};
      function next() {
...
class SStdio extends SClass {
  ...
  static new(id, sources, adapters, settings = {}) {
    return new Promise((resolve) => __awaiter$e(this, void 0, void 0, function* () {
      const __new = (yield __vitePreload(() => import("./new.5e57903c.js"), true ? [] : void 0)).default;
...
for (let key of ["log", "error", "warn", "verbose"]) {
  _nativeConsole$1[key] = (_a$4 = console[key]) !== null && _a$4 !== void 0 ? _a$4 : console.log;
}
class SStdioBasicAdapter extends SStdioAdapter {
  ...
  log(logObj) {
    ...
    if (!logObj)
      return;
    const logger = (_a2 = logObj.logger) !== null && _a2 !== void 0 ? _a2 : _nativeConsole$1.log;
  ...
  _ask(askObj) {
    return new SPromise(({ resolve, reject, emit }) => __awaiter$d(this, void 0, void 0, function* () {
...
class SStdioConsoleSource extends SStdioSource {
  constructor(settings) {
    ...
    console.ask = (askObj) => __awaiter$b(this, void 0, void 0, function* () {
  ...
  _overrideNativeConsole() {
    ...
    for (let key of [
      ...
      _nativeConsole[key] = (_a2 = console[key]) !== null && _a2 !== void 0 ? _a2 : _nativeConsole.log;
      console[key] = (...args) => {
        var _a3;
...
function __adoptStyleInShadowRoot($shadowRoot, $context = document) {
  return __awaiter$a(this, void 0, void 0, function* () {
    ...
    if ($links && $shadowRoot) {
      Array.from($links).forEach(($link) => __awaiter$a(this, void 0, void 0, function* () {
...
const threshold = 0;
try {
  (_a$3 = document === null || document === void 0 ? void 0 : document.addEventListener) === null || _a$3 === void 0 ? void 0 : _a$3.call(document, "pointermove", (e) => {
...
try {
  (_a$2 = document === null || document === void 0 ? void 0 : document.addEventListener) === null || _a$2 === void 0 ? void 0 : _a$2.call(document, "wheel", (e) => {
...
function __querySelectorLive(selector, cb = null, settings = {}, _isFirstLevel = true) {
  ...
  if (settings.scopes && (settings.rootNode === document || !((_a2 = settings.rootNode) === null || _a2 === void 0 ? void 0 : _a2.hasAttribute("s-scope")))) {
    ...
    innerPromises.push(__querySelectorLive("[s-scope]", ($scope) => __awaiter$6(this, void 0, void 0, function* () {
...
class SThemeBase extends SEventEmitter {
  ...
  static resolveCssPropertyValue(property, value, settings) {
    ...
    switch (dashProp) {
      ...
      case "background-color":
        let color = value, schema;
        if (Array.isArray(value) && value.length === 2) {
          color = value[0];
          schema = value[1];
        }
        return (_c2 = this.resolveColor(color, schema, null, Object.assign(Object.assign({}, settings !== null && settings !== void 0 ? settings : {}), { return: "value" }))) !== null && _c2 !== void 0 ? _c2 : value;
      case "border-radius":
  ...
  static remapCssColor(from2, to, settings) {
    ...
    if (__isColor(to)) {
      ...
      result2.vars = [
        `${this.compressVarName(`--s-theme-color-${from2}-h`)}: ${color.h};`,
        `${this.compressVarName(`--s-theme-color-${from2}-s`)}: ${color.s};`,
        `${this.compressVarName(`--s-theme-color-${from2}-l`)}: ${color.l};`,
        `${this.compressVarName(`--s-theme-color-${from2}-a`)}: ${color.a};`
      ];
      result2.properties[this.compressVarName(`--s-theme-color-${from2}-h`)] = color.h;
      result2.properties[this.compressVarName(`--s-theme-color-${from2}-s`)] = color.s;
      result2.properties[this.compressVarName(`--s-theme-color-${from2}-l`)] = color.l;
      result2.properties[this.compressVarName(`--s-theme-color-${from2}-a`)] = color.a;
    } else {
...
class SFront extends SClass {
  ...
  constructor(settings) {
    ...
    if (!SEnv.is("production")) {
      const color = SEnv.env.ENV === "production" ? "red" : SEnv.env.ENV === "staging" ? "cyan" : "green";
      console.log(`<yellow>[SFront]</yellow> Current environment is "<${color}>${SEnv.env.ENV}</${color}>"`);
    ...
    if (((_e2 = this.state.wireframe) === null || _e2 === void 0 ? void 0 : _e2.enabled) || this.settings.wireframe.enabled && this.state.wireframe.enabled === void 0) {
  ...
  setLod(level, settings) {
    ...
    if (((_b2 = cssSettings.lod) === null || _b2 === void 0 ? void 0 : _b2.method) === "file") {
    ...
    for (let i = 0; i <= level; i++) {
      ...
      if (((_c2 = cssSettings.lod) === null || _c2 === void 0 ? void 0 : _c2.method) === "file" && $stylesheet) {
  ...
  _initLod() {
    ...
    if (!isCrawler && this.state.lod.level === void 0 && this.settings.lod.defaultLevel === void 0) {
...
class SStateFsAdapter {
  ...
  _init() {
    ...
    return __awaiter$4(this, void 0, void 0, function* () {
      const _packageTmpDir = (yield __vitePreload(() => import("./packageTmpDir.360b362c.js"), true ? [] : void 0)).default;
...
((_d$1 = global$2.reactiveElementVersions) !== null && _d$1 !== void 0 ? _d$1 : global$2.reactiveElementVersions = []).push("1.6.1");
...
((_d = global$1.litHtmlVersions) !== null && _d !== void 0 ? _d : global$1.litHtmlVersions = []).push("2.6.1");
...
class SDropzoneComponent extends SLitComponent {
  ...
  _uploadFile(file) {
    return new SPromise(({ resolve, reject, emit }) => __awaiter(this, void 0, void 0, function* () {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield new Promise((resolve, reject) => {
        ...
        for (let [idx, file] of files.entries()) {
          ...
          if ((_b2 = (_a2 = file.type) === null || _a2 === void 0 ? void 0 : _a2.match) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, /^image\//)) {
  ...
  render() {
    ...
    return html`
      ...
      return html`
                                          <div
                                              class="${this.utils.cls(`__file __file--image __file--${(_c3 = (_b3 = (_a3 = file.type) === null || _a3 === void 0 ? void 0 : _a3.replace) === null || _b3 === void 0 ? void 0 : _b3.call(_a3, "/", "-")) !== null && _c3 !== void 0 ? _c3 : "unknown"}`)}"
                                          >
                                              ${((_e2 = (_d2 = file.type) === null || _d2 === void 0 ? void 0 : _d2.match) === null || _e2 === void 0 ? void 0 : _e2.call(_d2, /^image\//)) ? html`
                                                        <img
                                                            src="${file.src}"
                                                            alt="${file.alt}"
                                                        />
                ...
                ${this.props.input ? html`
                          <input
                              ...
                              hidden
                              accept=${(_a2 = this.props.accept) !== null && _a2 !== void 0 ? _a2 : "*"}
...
class SSpecsEditorComponent extends SLitComponent {
  ...
  getValuePathFromPath(path2, settings) {
    ...
    for (let i = 0; i < path2.length; i++) {
      ...
      if (propObj.responsive) {
        ...
        defaultMediaValuePath.push((_c2 = (_b2 = (_a2 = this.props.frontspec) === null || _a2 === void 0 ? void 0 : _a2.media) === null || _b2 === void 0 ? void 0 : _b2.defaultMedia) !== null && _c2 !== void 0 ? _c2 : "desktop");
      }
    }
    if (finalSettings.media) {
  ...
  clearValueFromPath(path2, settings) {
    ...
    if (this.isPathResponsive(path2)) {
      ...
      __deleteProperty((_a2 = this.props.specs.values) !== null && _a2 !== void 0 ? _a2 : {}, valuePath.join("."));
    } else {
  ...
  setValueFromPath(path2, value, settings) {
    ...
    if (this.isPathResponsive(path2)) {
      ...
      __set((_a2 = this.props.specs.values) !== null && _a2 !== void 0 ? _a2 : {}, valuePath.join("."), value);
    } else {
      const valuePath = path2.filter((p) => p !== "props").join(".");
    ...
    return html`
            <span>
                ${propObj.description ? html`
                      ...
                      ` : ""}
                ${(_a2 = propObj.title) !== null && _a2 !== void 0 ? _a2 : propObj.id}
      ...
      return html`
                                          <span
                                              class="${this.utils.cls("_media-icon")} ${mediaValue !== void 0 && mediaValue !== null ? "active" : ""} ${this.props.media === media ? "current" : ""} s-tooltip-container"
                                          >
                                              <span
  ...
  _renderSelectElement(propObj, path2) {
    var _a2, _b2, _c2;
    const value = (_a2 = this.getValueFromPath(path2)) !== null && _a2 !== void 0 ? _a2 : propObj.default;
    return html`
  ...
  _renderEditWidget(propObj, path2) {
    ...
    return widget.html(propObj, (_a2 = this.getValueFromPath(path2)) !== null && _a2 !== void 0 ? _a2 : {});
  }
  ...
  _renderElements(specs, path2 = [], forceNoRepeat = false) {
    ...
    if (!forceNoRepeat && _specs.type.match(/(\{\}|\[\])/)) {
      const loopOn = (_a2 = this.getValueFromPath(path2)) !== null && _a2 !== void 0 ? _a2 : [];
      return html`
        ...
        return html`
                            <div
                                ...
                                class="${this.utils.cls("_repeatable-title")} ${this._isActive(`${path2.join(".")}-${i}`) ? "active" : ""}"
                            >
                                ${(_c2 = (_b2 = (_a3 = v.title) !== null && _a3 !== void 0 ? _a3 : v.name) !== null && _b2 !== void 0 ? _b2 : v.id) !== null && _c2 !== void 0 ? _c2 : `${_specs.title} #${i}`}
                            ...
                            <div
                                tabindex="0"
                                class="${this.utils.cls("_repeatable-item")} ${this._isActive(`${path2.join(".")}-${i}`) ? "active" : ""}"
                            >
                                <div
                                    class="${this.utils.cls("_repeatable-item-actions")} ${this._isActive(`${path2.join(".")}-${i}`) ? "active" : ""}"
                                >
                                    <button
  ...
  render() {
    ...
    return html`
            <div
                class="${(_a2 = this.cu) === null || _a2 === void 0 ? void 0 : _a2.cls("", null, "s-bare")}"
                id="${this.props.id}"

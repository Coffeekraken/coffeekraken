...
class SStateFsAdapter {
  ...
  _init() {
    ...
    return __awaiter$b(this, void 0, void 0, function* () {
      const _packageTmpDir = (yield __vitePreload(() => import("./packageTmpDir.8aa46282.js"), true ? [] : void 0)).default;
...
class SCarpenterComponent extends SLitComponent {
  ...
  async _fetchSpecs(dotpath) {
    ...
    const specsJson = await fetch(
      `http://${document.location.hostname}:${document.location.port}/${dotpath}`

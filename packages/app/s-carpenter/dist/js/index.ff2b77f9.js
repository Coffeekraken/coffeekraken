...
class SStateFsAdapter {
  ...
  _init() {
    ...
    return __awaiter$b(this, void 0, void 0, function* () {
      const _packageTmpDir = (yield __vitePreload(() => import("./packageTmpDir.a094aebb.js"), true ? [] : void 0)).default;
  ...
  render() {
    ...
    return html`
            ...
            ${this.state.specs ? html`
                ...
                <div
                    id="${this.state.id}"
                    class="${(_a3 = this.state._componentUtils) === null || _a3 === void 0 ? void 0 : _a3.className("", null, "s-bare")}"
                >
                    ${Object.keys(this.state.specs.props).map((prop) => {
      this.state.specs.props[prop];
      return html`

                        <div
                            prop={v.id}
                            class={this.state._component.className('__prop')}
                        >
                            <Show when={v.type.toLowerCase() === 'text'}>
                                <div
                                    class={this.state._component.className(
                                        '__prop--text',
                                    )}
                                >
                                    <label
...
class SCarpenterComponent extends SLitComponent {
  ...
  async mount() {
    this.state.$set("*", (v) => {
      console.log("secs", v, JSON.stringify(this.state.specs));
    });

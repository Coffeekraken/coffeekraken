...
class SStateFsAdapter {
  ...
  _init() {
    ...
    return __awaiter$b(this, void 0, void 0, function* () {
      const _packageTmpDir = (yield __vitePreload(() => import("./packageTmpDir.15c7cfe6.js"), true ? [] : void 0)).default;
...
class SCarpenterComponent extends SLitComponent {
  constructor() {
    ...
    this._fetchSpecs(document.location.pathname.slice(1));
  }
  static get properties() {
  ...
  async _fetchSpecs(dotpath) {
    ...
    const specsJson = await fetch(
      `http://127.0.0.1:${(_c2 = (_b2 = (_a3 = this.settings.carpenter) == null ? void 0 : _a3.server) == null ? void 0 : _b2.port) != null ? _c2 : 3001}/${dotpath}`

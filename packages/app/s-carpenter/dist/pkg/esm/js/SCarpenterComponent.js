...
export default class SCarpenterComponent extends __SLitComponent {
    ...
    _initEditor() {
        ...
        const iframeHtml = `
            ...
            <s-carpenter-app id="${(_a = this.props.id) !== null && _a !== void 0 ? _a : 's-carpenter'}" save-state ${this.props.sidebar ? 'sidebar' : ''} ${this.props.autoEdit ? 'auto-edit' : ''} ${this.props.values
            ? `values='${JSON.stringify(this.props.values)}'`
            : ''} ${this.props.specs
            ? `specs='${JSON.stringify(this.props.specs)}'`
            : ''} ${this.props.source
            ? `source='${JSON.stringify(this.props.source)}'`
            : ''} ${this.props.escape ? 'escape' : ''} ${this.props.features
...
//# sourceMappingURL=data:application/json;base64,
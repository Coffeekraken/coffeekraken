...
export default class SCarpenterComponentInterface extends __SInterface {
    static get _definition() {
        return {
            ...
            specsObjUrl: {
                type: 'String',
                description: 'Specify the url where to get back the specs object for a particular spec. Note that you can/must use the :specs token in your url',
                default: '/carpenter/specs/:specs',
                required: true,
            },
            saveComponentUrl: {
                type: 'String',
                description: 'Specify the url where to POST the component json when clicking on the "save" button on top of the editor',
                default: '/carpenter',
                required: true,
            },
            deleteComponentUrl: {
                type: 'String',
                description: 'Specify the url where to DELETE the component json when clicking on the "delete" button on top of the editor. The %uid is available',
                default: '/carpenter/:uid',
                required: true,
            },
            savePageUrl: {
                type: 'String',
                description: 'Specify the url where to POST the page json when clicking on the "save page" button',
                default: '/carpenter',
                required: true,
            },
            adapter: {
...
//# sourceMappingURL=data:application/json;base64,
    ...
    static get _definition() {
        return {
            ...
            noPreviewIcon: {
                ...
                description:
                    'Specify an svg icon to be used when no preview is available for a particular "spec"',
            ...
            i18n: {
                ...
                default: {
                    // unsaved changes
                    unsavedConfirmation: __i18n(
                        "Their's some unsaved changes... Would you like to exit?",
                        {

...
var import_SImagesBuilderBuildParamsInterface = __toESM(require("../node/interface/SImagesBuilderBuildParamsInterface"), 1);
var import_SImagesBuilder = __toESM(require("../node/SImagesBuilder"), 1);
...
function build(stringArgs = "") {
  return new import_s_promise.default(async ({ resolve, reject, emit, pipe }) => {
    const builder = new import_SImagesBuilder.default({
      builder: {
        interface: import_SImagesBuilderBuildParamsInterface.default
      }
    });

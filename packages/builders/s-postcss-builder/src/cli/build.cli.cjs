...
var import_SPostcssBuilder = __toESM(require("../node/SPostcssBuilder"), 1);
var import_SPostcssBuilderBuildParamsInterface = __toESM(require("../node/interface/SPostcssBuilderBuildParamsInterface"), 1);
function build(stringArgs = "") {
  return new import_s_promise.default(async ({ resolve, reject, pipe }) => {
    const builder = new import_SPostcssBuilder.default({
      builder: {
        interface: import_SPostcssBuilderBuildParamsInterface.default
      }
    });

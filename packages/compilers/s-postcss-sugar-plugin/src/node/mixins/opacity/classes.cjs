...
__export(classes_exports, {
  ...
  interface: () => postcssSugarPluginOpacityClassesInterface
});
module.exports = __toCommonJS(classes_exports);
var import_s_interface = __toESM(require("@coffeekraken/s-interface"), 1);
var import_s_theme = __toESM(require("@coffeekraken/s-theme"), 1);
class postcssSugarPluginOpacityClassesInterface extends import_s_interface.default {
...
function classes_default({
  ...
  const opacityObj = import_s_theme.default.config("opacity");

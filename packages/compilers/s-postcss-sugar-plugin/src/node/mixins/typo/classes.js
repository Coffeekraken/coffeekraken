...
__export(classes_exports, {
  ...
  interface: () => postcssSugarPluginTypoClassesInterface
});
module.exports = __toCommonJS(classes_exports);
var import_s_interface = __toESM(require("@coffeekraken/s-interface"));
var import_s_theme = __toESM(require("@coffeekraken/s-theme"));
var import_faker = __toESM(require("faker"));
class postcssSugarPluginTypoClassesInterface extends import_s_interface.default {
...
function classes_default({
  ...
  const typosObj = import_s_theme.default.config("typo");
  vars.comment(() => `
      /**
        * @name          Typography
        ...
        * @support      edge            17+
        * 
        ${Object.keys(typosObj).map((typoName) => {
  ...
  Object.keys(typosObj).forEach((typoName) => {
    ...
    const css = import_s_theme.default.jsObjectToCssProperties(typoObj, {
    ...
    vars.comment(() => `/**
        ...
        @sugar.rhythm.vertical {
            ${typoName}, .${typoName} {
                ${import_s_theme.default.jsObjectToCssProperties((_a = typoObj.rhythmVertical) != null ? _a : {})}
            }
        }`);
  });
  return vars;

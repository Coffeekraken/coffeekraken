...
var import_SClipboardCopyComponentInterface = __toESM(require("./interface/SClipboardCopyComponentInterface"));
var import_s_lit_component = __toESM(require("@coffeekraken/s-lit-component"));
var import_copy = __toESM(require("@coffeekraken/sugar/js/clipboard/copy"));
var import_deepMerge = __toESM(require("@coffeekraken/sugar/shared/object/deepMerge"));
var import_s_clipboard_copy = __toESM(require("../../../../src/css/s-clipboard-copy.css"));

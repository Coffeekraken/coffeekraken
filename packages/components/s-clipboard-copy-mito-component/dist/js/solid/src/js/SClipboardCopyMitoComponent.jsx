...
function SClipboardCopyMito(props) {
  ...
  return <div class="s-clipboard-copy" onClick={event => _copyFromTarget()} state={status()}>
      <svg class="icon-copy" ref="svg" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default SClipboardCopyMito;
      ...
      return html`
                    ...
                    <div class="${this.componentUtils.className("__more-bar")}">
                        ${this._moreAction === "toggle" ? html`
                                      ...
                                      >
                                          ${this._more ? html` ${(_d = this.props.lessLabel) !== null && _d !== void 0 ? _d : "Show less"} ` : html` ${(_e = this.props.moreLabel) !== null && _e !== void 0 ? _e : "Show more"} `}
                                      </a>
                                  ` : html`
                                      <a
                                      ...
                                      >
                                          ${this._more ? html` ${(_f = this.props.lessLabel) !== null && _f !== void 0 ? _f : "Show less"} ` : html` ${(_g = this.props.moreLabel) !== null && _g !== void 0 ? _g : "Show more"} `}
                                      </a>
                                  `}                        
                        </a>
                    </div>

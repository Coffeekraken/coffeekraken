...
function bash(hljs) {
    ...
    Object.assign(VAR, {
        className: 'variable',
        variants: [{ begin: concat$3(/\$[\w\d#@][\w\d_]*/, `(?![\\w\\d])(?![$])`) }, BRACED_VAR],
    });
    const SUBST = {
        className: 'subst',
        begin: /\$\(/,
...
function javascript(hljs) {
    ...
    const CLASS_OR_EXTENDS = {
        variants: [
            ...
            {
                match: [/extends/, /\s+/, concat$1(IDENT_RE$12, '(', concat$1(/\./, IDENT_RE$12), ')*')],
                scope: {
                    1: 'keyword',
    ...
    const FUNCTION_CALL = {
        match: concat$1(/\b/, noneOf([...BUILT_IN_GLOBALS, 'super']), IDENT_RE$12, lookahead$1(/\(/)),
    ...
    const FUNCTION_VARIABLE = {
        match: [/const|var|let/, /\s+/, IDENT_RE$12, /\s*/, /=\s*/, lookahead$1(FUNC_LEAD_IN_RE)],
        className: {
            1: 'keyword',
            3: 'title.function',
        },
                    ...
                    ${((_c = this._items) !== null && _c !== void 0 ? _c : []).map((item) => {
                        ...
                        return html`
                            <pre
                                ...
                                ((_b2 = item.id) !== null && _b2 !== void 0 ? _b2 : item.lang)}"
                            >
                            <code lang="${(_c2 = item.lang) !== null && _c2 !== void 0
                                ? _c2

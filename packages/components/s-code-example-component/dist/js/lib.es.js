  ...
  render() {
    ...
    return html`
      ...
      return html`
                            ...
                            >
                            <code lang="${(_c2 = item.lang) !== null && _c2 !== void 0 ? _c2 : item.id}" class="language-${item.lang} ${item.lang} ${this.props.defaultStyle ? "hljs" : ""}">${item.code.trim()}</code>
                        </pre>
                        `;
    })}
                    <div class="${this.componentUtils.className("__more-bar")}">
                        ${this.moreAction === "toggle" ? html`
                                      ...
                                      >
                                          ${this.more ? html` ${(_d = this.props.lessLabel) !== null && _d !== void 0 ? _d : "Show less"} ` : html` ${(_e = this.props.moreLabel) !== null && _e !== void 0 ? _e : "Show more"} `}
                                      </a>
                                  ` : html`
                                      <a
                                      ...
                                      >
                                          ${this.more ? html` ${(_f = this.props.lessLabel) !== null && _f !== void 0 ? _f : "Show less"} ` : html` ${(_g = this.props.moreLabel) !== null && _g !== void 0 ? _g : "Show more"} `}
                                      </a>
                                  `}                        
                        </a>
                    </div>

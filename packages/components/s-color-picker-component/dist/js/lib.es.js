...
class SColorPicker extends LitElement {
  ...
  static get properties() {
    return __SComponentUtils.properties({}, SColorPickerComponentInterface);
  }
  static get styles() {
...
function webcomponent(tagName = "s-color-picker") {

...
const wrap =
    ((_a$1 = window.ShadyDOM) === null || _a$1 === void 0 ? void 0 : _a$1.inUse) &&
    ...
    for (let i = 0; i < l; i++) {
        ...
        html2 +=
            regex === textEndRegex
                ...
                : s + marker + (attrNameEndIndex === -2 ? (attrNames.push(void 0), i) : end);
    }
...
class TemplateInstance {
    ...
    _clone(options) {
        ...
        const fragment = (
            (_a2 = options === null || options === void 0 ? void 0 : options.creationScope) !== null && _a2 !== void 0
                ? _a2
                : d
    ...
    _commitTemplateResult(result) {
        ...
        const template =
            typeof type === 'number'
                ...
                : (type.el === void 0 && (type.el = Template.createElement(type.h, this.options)), type);
...
class EventPart extends AttributePart {
    ...
    _$setValue(newListener, directiveParent = this) {
        var _a2;
        newListener =
            (_a2 = resolveDirective(this, newListener, directiveParent, 0)) !== null && _a2 !== void 0 ? _a2 : nothing;
    ...
    handleEvent(event) {
        ...
        if (typeof this._$committedValue === 'function') {
            this._$committedValue.call(
                (_b2 = (_a2 = this.options) === null || _a2 === void 0 ? void 0 : _a2.host) !== null && _b2 !== void 0
                    ? _b2
                    : this.element,
                event,
            );
...
(_d = (_c$1 = globalThis)['litHtmlPlatformSupport']) === null || _d === void 0
    ? void 0
    : _d.call(_c$1, Template, ChildPart);
...
SDatePickerComponentInterface.definition = {
    ...
    i18n: {
        ...
        default:
            (_c = __SSugarConfig.get('datetime.i18n')) !== null && _c !== void 0
                ? _c
                : {
...
class SDatePicker extends __SLitComponent {
    ...
    firstUpdated() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let $button;
            if (this.props.button) $button = yield this._$button;
...
__decorate([queryAsync('input')], SDatePicker.prototype, '_$input', void 0);
__decorate([queryAsync('button')], SDatePicker.prototype, '_$button', void 0);

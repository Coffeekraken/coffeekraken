...
var import_SDatePickerComponentInterface = __toESM(require("./interface/SDatePickerComponentInterface"));
var import_pikaday = __toESM(require("pikaday"));
var import_whenInteract = __toESM(require("@coffeekraken/sugar/js/dom/detect/whenInteract"));
var import_moment = __toESM(require("moment"));
var import_pikaday2 = __toESM(require("pikaday/css/pikaday.css"));
var import_s_lit_component2 = __toESM(require("@coffeekraken/s-lit-component"));
var import_s_date_picker = __toESM(require("../../../../src/css/s-date-picker.css"));
var import_s_date_picker_theme = __toESM(require("../../../../src/css/s-date-picker-theme.css"));
    ...
    return import_lit.html`
            ...
            >
                ...
                ${!this._hasButton && this.props.button ? import_lit.html`
                          ...
                          >
                              ${this.calendarIcon ? import_lit.html` ${(0, import_static_html.html)(this.calendarIcon)} ` : import_lit.html`

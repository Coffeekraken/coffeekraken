...
import __css from "../../../../src/css/s-date-picker.css";
import __themeCss from "../../../../src/css/s-date-picker-theme.css";
    ...
    return html`
            ...
            >
                ...
                ${!this._hasButton && this.props.button ? html`
                          ...
                          >
                              ${this.calendarIcon ? html` ${staticHTML(this.calendarIcon)} ` : html`

...
var import_SSidePanelComponentInterface = __toESM(require("./interface/SSidePanelComponentInterface"));
...
var import_s_side_panel = __toESM(require("../../../../src/css/s-side-panel.css"));

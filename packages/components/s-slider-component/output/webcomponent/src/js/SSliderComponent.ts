...
export default class SSlider extends HTMLElement {
  ...
  updateBindings() {
    this._root.querySelectorAll("[data-el='div-s-slider-1']").forEach((el) => {
    ...
    this._root.querySelectorAll("[data-el='div-s-slider-2']").forEach((el) => {
      el.className = this.state._component?.className("__root");
    });

    this._root.querySelectorAll("[data-el='div-s-slider-3']").forEach((el) => {
      el.className = this.state._component?.className("__slides-wrapper");
    });

    this._root.querySelectorAll("[data-el='div-s-slider-4']").forEach((el) => {
      el.className = this.state._component?.className("__slides");
    });

    this._root.querySelectorAll("[data-el='show-s-slider']").forEach((el) => {
    ...
    this._root.querySelectorAll("[data-el='for-s-slider']").forEach((el) => {
      let array = this.state._slideElements;
      this.renderLoop(el, array, "child");
    });

    this._root.querySelectorAll("[data-el='div-s-slider-6']").forEach((el) => {
    ...
    this._root.querySelectorAll("[data-el='div-s-slider-7']").forEach((el) => {
    ...
    this._root.querySelectorAll("[data-el='div-s-slider-8']").forEach((el) => {

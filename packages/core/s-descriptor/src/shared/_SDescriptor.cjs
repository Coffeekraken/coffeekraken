...
var import_ofType = __toESM(require("@coffeekraken/sugar/shared/is/ofType"));
var import_typeof = __toESM(require("@coffeekraken/sugar/shared/value/typeof"));
var import_SDescriptorResult = __toESM(require("./SDescriptorResult"));
...
var import_set = __toESM(require("@coffeekraken/sugar/shared/object/set"));

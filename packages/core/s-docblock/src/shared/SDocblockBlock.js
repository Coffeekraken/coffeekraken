...
var import_install = __toESM(require("./tags/install"), 1);
var import_author = __toESM(require("./tags/author"), 1);
var import_contributor = __toESM(require("./tags/contributor"), 1);
var import_simpleValue = __toESM(require("./tags/simpleValue"), 1);
var import_simpleRepeatableValue = __toESM(require("./tags/simpleRepeatableValue"), 1);
var import_description = __toESM(require("./tags/description"), 1);
var import_return = __toESM(require("./tags/return"), 1);
var import_example = __toESM(require("./tags/example"), 1);
var import_param = __toESM(require("./tags/param"), 1);
var import_see = __toESM(require("./tags/see"), 1);
var import_snippet = __toESM(require("./tags/snippet"), 1);
var import_platform = __toESM(require("./tags/platform"), 1);
var import_namespace = __toESM(require("./tags/namespace"), 1);
var import_todo = __toESM(require("./tags/todo"), 1);
var import_menu = __toESM(require("./tags/menu"), 1);
var import_cssClass = __toESM(require("./tags/cssClass"), 1);
var import_interface = __toESM(require("./tags/interface"), 1);
var import_support = __toESM(require("./tags/support"), 1);

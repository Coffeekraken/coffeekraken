...
export interface ISLogConsoleCtorSettings {
  logConsoleAdapter: Partial<ISLogConsoleSettings>;
}
export interface ISLogConsoleSettings {
  enableChildProcessLogs: boolean;
...
export = class SLogConsoleAdapter extends __SLogAdapter {
   ...
   * @author    Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
   */
  constructor(settings: Partial<ISLogConsoleCtorSettings>) {
    // extend settings
    super(
      __deepMerge(
        {

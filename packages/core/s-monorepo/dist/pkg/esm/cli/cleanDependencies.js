...
// @ts-nocheck
import __SMonorepoCleanDependenciesParamsInterface from '../node/interface/SMonorepoCleanDependenciesParamsInterface.js';
import __SMonorepo from '../node/SMonorepo.js';
export default (stringArgs = '') => {
    return new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
        const finalParams = __SMonorepoCleanDependenciesParamsInterface.apply(stringArgs);

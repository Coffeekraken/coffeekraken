...
export default class SPackage extends __SClass {
    ...
    _exportFiles(
        ...
        return new Promise((resolve) => {
            ...
            console.log(
                `<yellow>[exports]</yellow> Generating new exports object map...`,
            );
            ...
            console.log(
                `<yellow>[exports]</yellow> Updating <cyan>package.json</cyan> file with new exports`,
            );
     ...
     */
    exports(
        params: ISPackageExportsParams,
    ): Promise<ISPackageExportsResult | void> {
        return new Promise(async (resolve) => {
            ...
            console.verbose?.(
                `<yellow>[exports]</yellow> Searching for exportable files...`,
            );
            ...
            if (finalParams.watch) {
                console.verbose?.(
                    `<yellow>[exports]</yellow> Watching for exportable files changes...`,
                );
            ...
            if (
                ...
                await this._exportFiles(files, finalParams);
            }
        ...
        return new Promise(async (resolve) => {
            ...
            if (__fs.existsSync(`${packageRoot}/package.json`)) {
                ...
                if (Array.isArray(finalParams.dependencies)) {
                    console.log(
                        `<yellow>[install]</yellow> Adding default dependencies: <magenta>${finalParams.dependencies.join(
                            '<white>,</white> ',
                        )}</magenta>`,
                    );
                } else {
                    console.log(
                        `<yellow>[install]</yellow> Adding default dependencies: <magenta>${Object.keys(
            ...
            if (__fs.existsSync(`${packageRoot}/composer.json`)) {
                console.log(
                    `<yellow>[install]</yellow> Installing the composer <cyan>vendors</cyan> dependencies...`,
                );
    ...
    checkDependencies(
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (!__fs.existsSync(`${packageRoot}/package.json`)) {
                console.error(
                    `<red>[checkDependencies]</red> No <cyan>package.json</cyan> file found in the root of your package`,
                );
                return reject();
            }
    ...
    rename(
        ...
        return new Promise(async (resolve) => {
            ...
            if (finalParams.folder) {
                ...
                console.log(
                    `<yellow>[rename]</yellow> Renaming the folder with "<cyan>${folderName}</cyan>"`,
                );
    ...
    ): Promise<ISPackageAddDefaultPackageJsonResult | void> {
        return new Promise(async (resolve) => {
            // @ts-ignore
            ...
            // Adding README
            console.log(
                `<yellow>[applyDefaultPackageJson]</yellow> Applying <cyan>config.package.defaultPackageJson</cyan> to the package.json file`,
            );
            ...
            console.log(
                `<green>[applyDefaultPackageJson]</green> <cyan>config.package.defaultPackageJson</cyan> applied <green>successfully</green>`,
            );

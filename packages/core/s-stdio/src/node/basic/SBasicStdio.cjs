...
var import_countLines = __toESM(require("@coffeekraken/sugar/node/terminal/countLines"));
...
var import_stripAnsi = __toESM(require("@coffeekraken/sugar/shared/string/stripAnsi"));
var import_upperFirst = __toESM(require("@coffeekraken/sugar/shared/string/upperFirst"));
var __Enquirer = __toESM(require("enquirer"));
var import_SStdio = __toESM(require("../../shared/SStdio"));
var import_defaultBasicStdioComponent = __toESM(require("./components/defaultBasicStdioComponent"));
var import_errorBasicStdioComponent = __toESM(require("./components/errorBasicStdioComponent"));

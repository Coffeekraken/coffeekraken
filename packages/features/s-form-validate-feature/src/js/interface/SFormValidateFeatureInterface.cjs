...
var SFormValidateFeatureInterface_exports = {};
__export(SFormValidateFeatureInterface_exports, {
  default: () => SFormValidateFeatureInterface
});
module.exports = __toCommonJS(SFormValidateFeatureInterface_exports);
var import_s_interface = __toESM(require("@coffeekraken/s-interface"));
class SFormValidateFeatureInterface extends import_s_interface.default {

...
var import_SPageTransitionFeatureInterface = __toESM(require("./interface/SPageTransitionFeatureInterface"));
var import_s_request = __toESM(require("@coffeekraken/s-request"));
var import_querySelectorUp = __toESM(require("@coffeekraken/sugar/js/dom/query/querySelectorUp"));

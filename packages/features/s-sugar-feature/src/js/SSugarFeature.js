...
var import_SSugarFeatureInterface = __toESM(require("./interface/SSugarFeatureInterface"), 1);
var import_clearTransmations = __toESM(require("@coffeekraken/sugar/js/dom/transmation/clearTransmations"), 1);
var import_inputAdditionalAttributes = __toESM(require("@coffeekraken/sugar/js/feature/inputAdditionalAttributes"), 1);
var import_linksStateAttributes = __toESM(require("@coffeekraken/sugar/js/feature/linksStateAttributes"), 1);
var import_preventScrollRestoration = __toESM(require("@coffeekraken/sugar/js/dom/scroll/preventScrollRestoration"), 1);

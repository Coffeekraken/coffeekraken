...
export function getLeadingComment(path: FastPath): CommentNode | undefined {
  ...
  let prev: Node | undefined = siblings.find(
 ...
 */
export function doesEmbedStartAfterNode(
  node: Node,
  path: FastPath,
...
export function getAttributeTextValue(
...
export function isInsideQuotedAttribute(
  path: FastPath,
  options: ParserOptions
): boolean {

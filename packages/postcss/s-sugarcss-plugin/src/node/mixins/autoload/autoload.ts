...
export interface ISSugarcssPluginAutoloadMixinParams {
    glob: string;
    depth: number;
}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginAutoloadMixinParams>;
    atRule: any;
    CssVars: any;
    getRoot: Function;
    postcssApi: any;
    ...
    const finalParams: ISSugarcssPluginAutoloadMixinParams = {
        glob: 'autoload.css',
        depth: 4,
        ...params,
    };

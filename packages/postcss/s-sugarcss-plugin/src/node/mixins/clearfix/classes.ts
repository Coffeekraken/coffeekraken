...
export interface ISSugarcssPluginClearfixClassesParams {
    defaultClearfix;
}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginClearfixClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginClearfixClassesParams = {

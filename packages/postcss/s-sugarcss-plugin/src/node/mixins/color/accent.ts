...
export interface ISSugarcssPluginColorPrimaryParams {
    color: string;
}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginColorPrimaryParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginColorPrimaryParams = {
        color: '',
        ...params,
    };

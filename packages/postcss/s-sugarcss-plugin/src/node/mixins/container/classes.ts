...
export interface ISSugarcssPluginContainerClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginContainerClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginContainerClassesParams = {
        ...params,
    };

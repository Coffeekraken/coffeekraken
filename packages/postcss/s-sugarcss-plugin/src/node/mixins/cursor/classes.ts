...
export interface ISSugarcssPluginCursorClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginCursorClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginCursorClassesParams = {
        ...params,
    };

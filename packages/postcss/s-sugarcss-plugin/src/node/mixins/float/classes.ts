...
export interface ISSugarcssPluginFloatClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginFloatClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginFloatClassesParams = {
        ...params,
    };

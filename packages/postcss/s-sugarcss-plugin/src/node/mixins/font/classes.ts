...
export interface ISSugarcssPluginFontClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginFontClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginFontClassesParams = {
        ...params,
    };
    ...
    const fontsFamiliesObj = __STheme.current.get('fontFamily'),
        fontSizesObj = __STheme.current.get('fontSize'),
        fontStretchProps = [
            'ultra-condensed',
            'extra-condensed',
            'condensed',

...
export interface ISSugarcssPluginGradientClassesParams {
    types: string[];
    angles: number[];
}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginGradientClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginGradientClassesParams = {
        types: ['linear', 'radial'],

...
export interface ISSugarcssPluginGroupClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginGroupClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginGroupClassesParams = {
        ...params,
    };

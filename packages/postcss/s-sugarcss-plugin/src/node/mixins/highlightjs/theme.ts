...
export interface ISSugarcssPluginHighlightjsThemeParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginHighlightjsThemeParams>;
    atRule: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginHighlightjsThemeParams = {
        ...params,
    };

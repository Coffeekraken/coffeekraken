...
export interface ISSugarcssPluginLinkClassesMixinParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginLinkClassesMixinParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginLinkClassesMixinParams = {
        ...params,
    };

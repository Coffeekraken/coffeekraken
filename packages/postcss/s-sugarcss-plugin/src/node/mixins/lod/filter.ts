...
export interface SSugarcssPluginLodFilterMixinParams {
    level: number | string;
}
export default function ({
    ...
    params: Partial<SSugarcssPluginLodFilterMixinParams>;
    atRule: any;
    settings: any;
    postcssApi: any;
}) {
    const finalParams = <SSugarcssPluginLodFilterMixinParams>{
        level: 0,
        ...(params ?? {}),
    };

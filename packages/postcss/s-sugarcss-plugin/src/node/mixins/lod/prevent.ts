...
import { ISSugarcssPluginColorParams } from '../../functions/color/color.js';
...
export interface SSugarcssPluginScopePreventMixinParams {}
...
export default function ({
    ...
    const finalParams = <SSugarcssPluginScopePreventMixinParams>{
        scopes: [],
        ...(params ?? {}),
    };

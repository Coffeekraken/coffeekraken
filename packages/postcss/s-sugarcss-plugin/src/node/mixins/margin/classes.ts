...
export interface ISSugarcssPluginMarginClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginMarginClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginMarginClassesParams = {
        ...params,
    };

...
export interface ISSugarcssPluginOffsizeClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginOffsizeClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginOffsizeClassesParams = {
        ...params,
    };

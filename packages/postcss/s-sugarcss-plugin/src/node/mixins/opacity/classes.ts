...
export interface ISSugarcssPluginOpacityClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginOpacityClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginOpacityClassesParams = {
        ...params,
    };

    const vars = new CssVars();

    const opacityObj = __STheme.current.get('opacity');

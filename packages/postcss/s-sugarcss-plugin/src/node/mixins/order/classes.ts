...
export interface ISSugarcssPluginOrderClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginOrderClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginOrderClassesParams = {
        ...params,
    };

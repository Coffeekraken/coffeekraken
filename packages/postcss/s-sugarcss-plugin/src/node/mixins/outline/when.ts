...
export interface SSugarcssPluginStateOutlineWhenMixinParams {
...
export default function ({
    ...
    params: Partial<SSugarcssPluginStateOutlineWhenMixinParams>;
    atRule: any;
    replaceWith: Function;
}) {
    const finalParams = <SSugarcssPluginStateOutlineWhenMixinParams>{
        when: ['focus'],
        color: 'current',
        ...(params ?? {}),
    };

...
export interface ISSugarcssPluginPaddingClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginPaddingClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginPaddingClassesParams = {
        ...params,
    };

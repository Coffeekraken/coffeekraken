...
export interface ISSugarcssPluginAssetPlatformParams {
    platform: string;
}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginAssetPlatformParams>;
    atRule: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginAssetPlatformParams = {
        platform: '',
        ...params,
    };

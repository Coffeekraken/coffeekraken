...
export interface ISSugarcssPluginPointerClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginPointerClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginPointerClassesParams = {
        ...params,
    };

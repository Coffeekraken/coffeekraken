...
export interface ISSugarcssPluginPositionClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginPositionClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginPositionClassesParams = {
        ...params,
    };

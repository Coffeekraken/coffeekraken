...
export interface ISSugarcssPluginRatioClassesParams {
    ratio: number;
}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginRatioClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginRatioClassesParams = {
        ratio: 1,
        ...params,
    };

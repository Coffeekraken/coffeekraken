...
export interface ISSugarcssPluginResetDestyleParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginResetDestyleParams>;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginResetDestyleParams = {
        ...params,
    };

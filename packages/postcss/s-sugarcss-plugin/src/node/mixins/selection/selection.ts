...
export interface ISSugarcssPluginLookAndFeelSelectionParams {
    color: string;
}
...
export default function ({
    ...
    params: ISSugarcssPluginLookAndFeelSelectionParams;
    atRule: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginLookAndFeelSelectionParams = {
        color: 'accent',
        ...params,
    };

...
export interface ISSugarcssPluginShadowGradientParams {
    x: number | string;
    y: number | string;
    blur: number | string;
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginShadowGradientParams>;
    atRule: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginShadowGradientParams = {
        x: 0,
        y: 0,
        blur: 0,
        spread: 0,

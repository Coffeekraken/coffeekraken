...
export interface ISSugarcssPluginShapeClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginShapeClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginShapeClassesParams = {
        ...params,
    };

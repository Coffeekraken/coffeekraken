...
export interface ISSugarcssPluginTransitionClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginTransitionClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginTransitionClassesParams = {
        ...params,
    };

...
export interface SSugarcssPluginTransitionMixinParams {
    name: string;
}
...
export default function ({
    ...
    params: Partial<SSugarcssPluginTransitionMixinParams>;
    atRule: any;
    replaceWith: Function;
}) {
    const finalParams = <SSugarcssPluginTransitionMixinParams>{
        ...(params ?? {}),
    };
    const vars: string[] = [

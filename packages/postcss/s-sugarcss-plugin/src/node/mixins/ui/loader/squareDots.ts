...
export interface ISSugarcssPluginUiLoaderSquareDotsMixinParams {
    name: string;
    duration: string;
}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginUiLoaderSquareDotsMixinParams>;
    atRule: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginUiLoaderSquareDotsMixinParams = {
        name: '',
        duration: '',
        ...params,
    };

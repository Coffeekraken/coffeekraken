...
export interface ISSugarcssPluginUiToggleClassesParams {
    types: 'burger'[];
}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginUiToggleClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginUiToggleClassesParams = {
        types: ['burger'],
        ...params,
    };

...
export interface ISSugarcssPluginUntilClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginUntilClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginUntilClassesParams = {
        ...params,
    };

...
export interface ISSugarcssPluginUserSelectClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginUserSelectClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginUserSelectClassesParams = {
        ...params,
    };

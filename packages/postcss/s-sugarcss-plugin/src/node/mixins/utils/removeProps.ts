...
export interface SSugarcssPluginUtilsRemovePropsMixinParams {
    props: string;
}
export default function ({
    ...
    params: Partial<SSugarcssPluginUtilsRemovePropsMixinParams>;
    atRule: any;
    getRoot: Function;
    settings: any;
    postcssApi: any;
}) {
    const finalParams = <SSugarcssPluginUtilsRemovePropsMixinParams>{
        props: '',
        ...(params ?? {}),
    };

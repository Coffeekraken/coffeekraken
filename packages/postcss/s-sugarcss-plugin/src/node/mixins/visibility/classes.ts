...
export interface ISSugarcssPluginOverflowClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginOverflowClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginOverflowClassesParams = {
        ...params,
    };

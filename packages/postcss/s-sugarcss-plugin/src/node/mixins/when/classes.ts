...
export interface ISSugarcssPluginActiveClassesParams {}
...
export default function ({
    ...
    params: Partial<ISSugarcssPluginActiveClassesParams>;
    atRule: any;
    CssVars: any;
    replaceWith: Function;
}) {
    const finalParams: ISSugarcssPluginActiveClassesParams = {
        ...params,
    };

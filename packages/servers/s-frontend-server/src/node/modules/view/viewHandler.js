...
var viewHandler_exports = {};
__export(viewHandler_exports, {
  default: () => view
});
module.exports = __toCommonJS(viewHandler_exports);
...
async function view(req, res, settings = {}) {
  ...
  const viewInstance = new import_s_view_renderer.default(viewPath);

...
/**
 * @name                SMochaTesterStartParamsInterface
 ...
 */
export default class SMochaTesterStartParamsInterface extends __SInterface {
    static get _definition() {
        return {
            glob: {
                ...
                type: 'Array<String>',
                default: __SSugarConfig.get('jestTester.glob'),
                alias: 'g',
            },
            inDir: {
                description:
                ...
                type: 'String',
                default: __SSugarConfig.get('jestTester.inDir'),
                alias: 'i',
            },
            packageRoot: {
            ...
            exclude: {
                ...
                type: 'Array<String>',
                default: __SSugarConfig.get('jestTester.exclude'),
                alias: 'e',
            },
        };
    }

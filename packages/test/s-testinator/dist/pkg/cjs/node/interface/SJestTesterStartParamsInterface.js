...
/**
 * @name                SJestTesterStartParamsInterface
 ...
 * @platform             node
 *
 * This interface specify the parameters needed to the `sugar jest.start` command.
 *
 * @since       2.0.0
 * @author    Olivier Bossel <olivier.bossel@gmail.com> (https://coffeekraken.io)
 */
class SJestTesterStartParamsInterface extends s_interface_1.default {
    static get _definition() {
        return {
            glob: {
                description: 'Sppecify some globs relative to the inDir to find the files you want to build',
                type: 'Array<String>',
                default: s_sugar_config_1.default.get('jestTester.glob'),
                alias: 'g',
            },
            inDir: {
                description: 'Specify a directory from where to search for ts and js files to build',
                type: 'String',
                default: s_sugar_config_1.default.get('jestTester.inDir'),
                alias: 'i',
            },
            packageRoot: {
            ...
            exclude: {
                ...
                type: 'Array<String>',
                default: s_sugar_config_1.default.get('jestTester.exclude'),
                alias: 'e',
            },
        };
    }
}
exports.default = SJestTesterStartParamsInterface;

...
var import_convert = __toESM(require("@coffeekraken/sugar/shared/color/convert"));
var import_hsla2rgba = __toESM(require("@coffeekraken/sugar/shared/color/hsla2rgba"));
var import_rgba2hex = __toESM(require("@coffeekraken/sugar/shared/color/rgba2hex"));
var import_rgba2hsla = __toESM(require("@coffeekraken/sugar/shared/color/rgba2hsla"));
var import_deepMerge = __toESM(require("@coffeekraken/sugar/shared/object/deepMerge"));
var import_SColorApplyParamsInterface = __toESM(require("./interface/SColorApplyParamsInterface"));
var import_SColorSettingsInterface = __toESM(require("./interface/SColorSettingsInterface"));

...
import __parseRgba from '@coffeekraken/sugar/shared/color/parseRgba';
import __parseHsl from '@coffeekraken/sugar/shared/color/parseHsl';
import __parseHsv from '@coffeekraken/sugar/shared/color/parseHsv';
import __rgba2hex from '@coffeekraken/sugar/shared/color/rgba2hex';
import __hex2rgba from '@coffeekraken/sugar/shared/color/hex2rgba';
...
import __parse from '@coffeekraken/sugar/shared/color/parse';
...
export interface ISColorCtorSettings {
  color: Partial<ISColorSettings>;
}
export interface ISColorSettings {
  returnNewInstance: boolean;
  defaultFormat: 'hex' | 'rgb' | 'rgba' | 'hsl' | 'hsv';
}

...
var import_when = __toESM(require("@coffeekraken/sugar/js/dom/detect/when"));
...
var import_SConductorSettingsInterface = __toESM(require("./interface/SConductorSettingsInterface"));

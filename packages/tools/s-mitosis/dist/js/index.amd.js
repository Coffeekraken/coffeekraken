...
define(["require", "exports"], function(require, exports) {
  ...
  (function(module, exports2) {
    (function(root) {
      ...
      {
        if (module.exports) {
          exports2 = module.exports = isClass2;
        }
  ...
  var isClass = function isClassConstructor(fn2) {
    ...
    try {
      var match = $stringMatch($functionToString(fn2), classRegex);
      return !!match;
    } catch (e) {
    }
    return false;
  ...
  var implementation$8 = function getName() {
    ...
    var match = $stringMatch(str2, regex);
  ...
  var getProto$1 = function getPrototypeOf2(value) {
  ...
  var implementation$2 = function getPrototypeOf2(O) {
  ...
  var getProto = function getPrototypeOf2(value) {
    RequireObjectCoercible(value);
    return value.__proto__;
  };
  var $getPrototypeOf = Object.getPrototypeOf;
  var getPrototypeOfPrimitivesToo = function getPrototypeOf2(value) {
    RequireObjectCoercible(value);
  ...
  function expand$3(str2, isTop) {
    ...
    if (!isSequence && !isOptions) {
      if (m.post.match(/,.*\}/)) {
        str2 = m.pre + "{" + m.body + escClose$1 + m.post;
  ...
  (function(exports2) {
    ...
    exports2.tokenizeClass = function(str2, regexpStr) {
      var tokens = [];
...
${settingsArray.join("\n")}
  ...
  function __parseArgs(string2, settings) {
    ...
    if (settings.treatNoAsBoolean) {
      ...
      noMatches === null || noMatches === void 0 ? void 0 : noMatches.forEach((match) => {
        string2 = string2.replace(match, `${match.replace("--no-", "--")} false`);
      });
    }
  ...
  class SStateFsAdapter {
    ...
    _init() {
      ...
      return __awaiter$a(this, void 0, void 0, function* () {
        const _packageTmpDir = (yield __vitePreload(() => new Promise((resolve, reject) => require(["./packageTmpDir.9e668423"], resolve, reject)), false ? "__VITE_PRELOAD__" : void 0)).default;
    ...
    save(state) {
      return new Promise((resolve) => __awaiter$a(this, void 0, void 0, function* () {
        const _fs = yield __vitePreload(() => new Promise((resolve2, reject) => require(["./__vite-browser-external_fs.3eefbdb2"], resolve2, reject)), false ? "__VITE_PRELOAD__" : void 0);
        yield this._init();
  ...
  function isRgb(color) {
    var keys2 = Object.keys(color);
    if (keys2.length !== 3)
      return false;
    if (!sameContent(keys2, ["r", "g", "b"]))
      return false;
      ...
      var runInContext = function runInContext2(context) {
        ...
        var stringToPath2 = memoizeCapped(function(string2) {
          ...
          string2.replace(rePropName2, function(match, number, quote, subString) {
            result3.push(quote ? subString.replace(reEscapeChar2, "$1") : number || match);
          });
          return result3;
        });
  ...
  function requireShim$2() {
    if (hasRequiredShim$2)
      return shim$2;
    hasRequiredShim$2 = 1;
    var keys2 = requireKeys(), value = validValue, max2 = Math.max;
  ...
  (function(module, exports2) {
    ...
    on = function(type, listener) {
      ...
      if (!hasOwnProperty2.call(this, "__ee__")) {
        ...
        defineProperty2(this, "__ee__", descriptor2);
    ...
    module.exports = exports2 = function(o) {
    ...
    generateName = function(desc) {
      ...
      defineProperty2(
        ...
        d2.gs(null, function(value) {
          ...
          defineProperty2(this, name2, d2(value));
  ...
  function requireShim() {
    if (hasRequiredShim)
      return shim;
    hasRequiredShim = 1;
    var iteratorSymbol = requireEs6Symbol().iterator, isArguments2 = requireIsArguments(), isFunction2 = requireIsFunction(), toPosInt = toPosInteger, callable = validCallable, validValue$1 = validValue, isValue2 = isValue$5, isString2 = requireIsString(), isArray2 = Array.isArray, call = Function.prototype.call, desc = { configurable: true, enumerable: true, writable: true, value: null }, defineProperty2 = Object.defineProperty;
  ...
  (() => __async(this, null, function* () {
    define();
    __querySelectorLive("[component]", ($app) => __async(this, null, function* () {
      const component = JSON.parse($app.getAttribute("component"));
      console.log(component);
      const componentImport = yield __vitePreload(() => new Promise((resolve, reject) => require([component.path], (m) => resolve(/* @__PURE__ */ _interopNamespace(m)), reject)), false ? "__VITE_PRELOAD__" : void 0);
  ...
  exports.SSugarConfig = SSugarConfig;

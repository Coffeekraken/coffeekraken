...
var SViteBuildParamsInterface_exports = {};
__export(SViteBuildParamsInterface_exports, {
  default: () => SViteBuildParamsInterface_default
});
module.exports = __toCommonJS(SViteBuildParamsInterface_exports);
var import_s_sugar_config = __toESM(require("@coffeekraken/s-sugar-config"), 1);
var import_s_interface = __toESM(require("@coffeekraken/s-interface"), 1);
class SViteBuildParamsInterface extends import_s_interface.default {
  static get _definition() {
    return {
      input: {
        ...
        default: `${import_s_sugar_config.default.get("storage.src.jsDir")}/index.ts`,
        required: true
      },
      type: {
...
var SViteBuildParamsInterface_default = SViteBuildParamsInterface;

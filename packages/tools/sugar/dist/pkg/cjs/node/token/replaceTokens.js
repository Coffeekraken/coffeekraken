...
const replacePackageJsonTokens_js_1 = __importDefault(require("../package/replacePackageJsonTokens.js"));
const replacePathTokens_js_1 = __importDefault(require("../path/replacePathTokens.js"));
/**
 * @name            replaceTokens
...
function replaceTokens(string) {
    string = (0, replaceTokens_js_1.default)(string);
    string = (0, replacePathTokens_js_1.default)(string);
    string = (0, replacePackageJsonTokens_js_1.default)(string);
    return string;
}
exports.default = replaceTokens;
//# sourceMappingURL=data:application/json;base64,
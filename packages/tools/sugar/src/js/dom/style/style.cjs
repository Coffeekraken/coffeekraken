...
function style(elm, styleObj) {
  ...
  if (styleAttr) {
    styleObj = __spreadValues(__spreadValues({}, (0, import_styleString2Object.default)(styleAttr)), styleObj);
  }
  elm.style.cssText = (0, import_styleObject2String.default)(styleObj);
  return elm.style;
}

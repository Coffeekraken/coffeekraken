    ...
    toMarkdown(settings = {}) {
        ...
        this._itemsArray.forEach((sNavItem) => {
            if (sNavItem instanceof __SNavItem) {
                ...
                itemsArray.push(sNavItem.toMarkdown(Object.assign(Object.assign({}, settings), { indent: settings.indent + 1 })));
            }
        });
...
${sNavItem.toHtml(Object.assign(Object.assign({}, settings), { indent: settings.indent + 1 }))}

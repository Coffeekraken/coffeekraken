 ...
 */
export default function validateDefinitionObject(definitionObject, settings = {}) {
    ...
    Object.keys(definitionObject).forEach((argName) => {
        ...
        // validate this
        const res = __validateObject(argDefinitionObj, __SDefinitionObjectInterface.definitionObj, {
            throw: true,

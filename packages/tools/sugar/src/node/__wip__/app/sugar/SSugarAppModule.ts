...
import { SBlessedStdio as __SBlessedStdio } from '@coffeekraken/s-stdio';
...
export default class SSugarAppModule
  ...
  constructor(
    ...
    stdios.forEach((stdio) => {
      ...
      const stdioInstance = __SStdio.new(this, stdioArg, stdioSettings);

      if (
        stdioInstance instanceof { SBlessedStdio as  || }

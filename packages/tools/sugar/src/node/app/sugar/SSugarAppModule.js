 ...
 */
module.exports = (_a = class SSugarAppModule extends __SPromise {
        /**
         * @name          constructor
         * @type          Function
         * @constructor
        ...
        run(params = {}, settings = {}, processId = 'main') {
            if (!this._moduleProcesses || !this._moduleProcesses[processId]) {
                throw new __SError(`Sorry but you cannot run a module process that does not have been registered during the "start" phase. Here's the available module processes: ${Object.keys(this._moduleProcesses).join(',')}`);
            }
        ...
        _initShortcuts() {
            Object.keys(this._settings.shortcuts || {}).forEach((shortcut) => {
                ...
                __hotkey(shortcut).on('press', () => {
                    if (!this.isActive())
                        return;
                    const params = __deepMerge(Object.assign({}, this.params, Object.assign({}, shortcutObj.params || {})));
                    const settings = __deepMerge(Object.assign({}, this._settings, Object.assign({}, shortcutObj.settings || {})));

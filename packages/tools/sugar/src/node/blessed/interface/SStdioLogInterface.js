...
module.exports = (_a = class SStdioLogInterface extends SInterface_1.default {
    },
    _a.definition = Object.assign(Object.assign({}, LogInterface_1.default.definition), { clear: {
            type: 'Boolean|Integer',
            description: 'If set to <yellow>true</yellow>, clear the entire Stdio stream, otherwise you can specify a number of line(s) to clear',
            alias: 'c'
        }, temp: {
            type: 'Boolean',
    ...
    _a);
//# sourceMappingURL=SStdioLogInterface.js.map
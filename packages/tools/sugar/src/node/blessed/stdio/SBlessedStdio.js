 ...
 */
const cls = (_a = class SBlessedStdio extends SBlessedComponent_1.default {
        /**
         * @name          constructor
         * @type          Function
         * @constructor
...
cls.registerComponent(SDefaultBlessedStdioComponent_1.default);
cls.registerComponent(SErrorBlessedStdioComponent_1.default);
cls.registerComponent(SWarningBlessedStdioComponent_1.default);
cls.registerComponent(SHeadingBlessedStdioComponent_1.default);
module.exports = cls;

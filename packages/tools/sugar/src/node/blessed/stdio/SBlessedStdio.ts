...
import __SStdioLogInterface from '../interface/SStdioLogInterface';
import __SStdioSourceInterface from '../interface/SStdioSourceInterface';
...
import ISBlessedStdio, {
  ISBlessedStdioCtor,
  ISBlessedStdioMetas,
  ISBlessedStdioSettings
} from './interface/ISBlessedStdio';
 ...
 */
const cls: ISBlessedStdioCtor = class SBlessedStdio
  extends __SBlessedComponent
  implements ISBlessedStdio {
  /**
...
cls.registerComponent(__SDefaultBlessedStdioComponent);
cls.registerComponent(__SErrorBlessedStdioComponent);
cls.registerComponent(__SWarningBlessedStdioComponent);
cls.registerComponent(__SHeadingBlessedStdioComponent);

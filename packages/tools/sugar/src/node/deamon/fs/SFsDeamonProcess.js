 ...
 */
module.exports = (_a = class SFsDeamonProcess extends __SProcess {
        /**
         * @name          constructor
         * @type          Function
         * @constructor
        ...
        process(params, settings = {}) {
            ...
            this._watcher = __chokidar
                ...
                this.log({
                    group: 'Updated files',
                    value: `File updated: "<yellow>${file.path.replace(__packageRoot(file.path) + '/', '')}</yellow>" <cyan>${file.size}</cyan>mb`
                });
                ...
                this.log({
                    group: 'Added files',
                    value: `File added: "<green>${file.path.replace(__packageRoot(file.path) + '/', '')}</green>" <cyan>${file.size}</cyan>mb`
                });
                ...
                this.log({
                    group: 'Deleted files',
                    value: `File deleted: "<red>${filepath.replace(__packageRoot(filepath) + '/', '')}</red>"`
                });
                this.trigger('unlink', {
                    path: filepath
                });
    ...
    _a.interface = __SFsDeamonInterface,
    _a);

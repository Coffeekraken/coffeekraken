 ...
 */
module.exports = (_a = class SBuildFrontspecSugarAppModule extends __SSugarAppModule {
        /**
         * @name            constructor
         * @type             Function
         * @constructor
         ...
         */
        start() {
            const pro = new __SBuildFrontspecProcess(this.params, this._settings.processSettings);

    ...
    function isPortFree(port) {
        ...
        return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, __syncRequire ? Promise.resolve().then(function () { return __importStar(require('http')); }) : new Promise(function (resolve_1, reject_1) { require(['http'], resolve_1, reject_1); }).then(__importStar)];
                    case 1:
                        server = _a.sent();
                        server
                            .createServer()

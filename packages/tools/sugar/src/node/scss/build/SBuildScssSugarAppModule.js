 ...
 */
module.exports = (_a = class SBuildScssSugarAppModule extends __SSugarAppModule {
        /**
         * @name            constructor
         * @type             Function
         * @constructor
         ...
         */
        start() {
            const pro = new __SBuildScssProcess(this.params, this._settings.processSettings);

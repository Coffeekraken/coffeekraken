 ...
 */
module.exports = (_a = class SFrontendServerInterface extends __SInterface {
    },
    _a.definitionObj = {
        hostname: {
            type: 'String',
        ...
        rootDir: {
            ...
            default: __sugarConfig('frontend.rootDir') || __packageRoot(process.cwd()),
            level: 1
        },
        viewsDir: {
            type: 'String',
            description: 'Server views directory',
            default: __sugarConfig('frontend.viewsDir') ||

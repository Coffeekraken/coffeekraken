 ...
 */
module.exports = (_a = class SPhpServerCli extends __SCli {
        /**
         * @name          constructor
         * @type          Function
         * @constructor
         ...
         * @author    Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
         */
        run(argsObj = this._settings.argsObj, includeAllArgs = this._settings.includeAllArgs, log = true) {
...
URL            : <cyan>http://${this.runningArgsObj.hostname}:${this.runningArgsObj.port}</cyan>`);
     ...
     * @author    Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
     */
    _a.command = 'php -S %hostname:%port -t %rootDir %router %arguments',
    /**
     * @name          interface
     * @type          Object
     * @static
     ...
     * @author    Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
     */
    _a.interface = __SPhpServerInterface,
    _a);

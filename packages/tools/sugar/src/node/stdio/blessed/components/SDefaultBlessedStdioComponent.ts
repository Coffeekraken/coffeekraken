...
export interface ISDefaultBlessedStdioComponent {}

class SDefaultBlessedStdioComponent
...
const cls: ISDefaultBlessedStdioComponentCtor = SDefaultBlessedStdioComponent;
export default SDefaultBlessedStdioComponent;

...
export interface ISErrorBlessedStdioComponentSettings
  extends ISBlessedStdioComponentSettings {}

export interface ISErrorBlessedStdioComponentCtor
  extends ISBlessedStdioComponentCtor {}

export interface ISErrorBlessedStdioComponent {}

class SErrorBlessedStdioComponent
...
const cls: ISErrorBlessedStdioComponentCtor = SErrorBlessedStdioComponent;
export default SErrorBlessedStdioComponent;

 ...
 */
module.exports = (_a = class SFsOutputStreamAction extends __SActionsStreamAction {
        /**
         * @name            constructor
         * @type            Function
         * @constructor
        ...
        run(streamObj, settings = this._settings) {
            return super.run(streamObj, async (resolve, reject, trigger) => {
                ...
                for (let i = 0; i < outputStackKeys.length; i++) {
                    ...
                    if (!__get(streamObj, key))
                        continue;
                    await __writeFile(outputPath, __toString(__get(streamObj, key), {
                        beautify: true
                    }));
                }
                resolve(streamObj);

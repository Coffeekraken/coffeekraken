 ...
 *
 * @snippet             __specsValuesAttribute($1)
 *
 * @example         twig
 * <div {{ __specsValuesAttribute(_context) }}>
 * </div>
 *
 * @since       2.0.0
 * @author         Olivier Bossel <olivier.bossel@gmail.com> (https://coffeekraken.io)
 */
return new \Twig\TwigFunction('__specsValuesAttribute', function ($values) {

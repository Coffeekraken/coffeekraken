...
var ddmmyyyyDate_exports = {};
__export(ddmmyyyyDate_exports, {
  default: () => ddmmyyyyDate_default
});
module.exports = __toCommonJS(ddmmyyyyDate_exports);
...
var ddmmyyyyDate_default = isDdmmyyyyDate;

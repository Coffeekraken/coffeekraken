...
var require_ensureExists = __commonJS({
  "packages/tools/sugar/src/shared/object/__tests__.wip/ensureExists.ts"(exports, module) {
    init_esm_shims();
...
export default require_ensureExists();

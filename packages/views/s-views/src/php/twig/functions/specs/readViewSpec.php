 ...
 *
 * @snippet             __readViewSpec($1)
 *
 * @example         twig
 * <code>
 *  {{ __readViewSpec('sugar.views.component.card') }}
 * </code>
 *
 * @since       2.0.0
 * @author         Olivier Bossel <olivier.bossel@gmail.com> (https://coffeekraken.io)
 */
return new \Twig\TwigFunction('__readViewSpec', function (
    $jsonDotPath,
    $sJsonSettings = []
) {
    return \SViews\specs\readViewSpec($jsonDotPath, $sJsonSettings);
});

...
!function(e) {
  ...
  var isClass = {exports: {}}, B, C;
  B = isClass, C = isClass.exports, function() {
    ...
    (C = B.exports ? B.exports = e : C).isClass = e;
  }();
  ...
  !function(e, t) {
    ...
    function L(e2, t2, r2, n2) {
      var o2 = -1, i2 = e2 ? e2.length : 0;
      for (n2 && i2 && (r2 = e2[++o2]); ++o2 < i2; )
    ...
    function ge(e2, t2) {
      var r2, n2, o2, i2, s2 = Me(e2) || function(e3) {
        return function(e4) {
      ...
      for (n2 in e2)
        !t2 && !K.call(e2, n2) || c2 && (n2 == "length" || (o2 = n2, !!(i2 = (i2 = a2) == null ? l : i2) && (typeof o2 == "number" || u.test(o2)) && -1 < o2 && o2 % 1 == 0 && o2 < i2)) || s2.push(n2);
      return s2;
    }
    ...
    function me(r2, n2, o2, i2, e2, t2, s2) {
      var a2;
      if ((a2 = i2 ? t2 ? i2(r2, e2, t2, s2) : i2(r2) : a2) !== void 0)
        return a2;
      if (!Re(r2))
        return r2;
      var c2, l2 = Me(r2);
            ...
            switch (t3) {
              ...
              case b:
                return function(e4, t4, r4) {
                  return L(t4 ? r4(D(e4), true) : D(e4), G, new e4.constructor());
                }(e3, n3, r3);
              case m:
              case S:
                return new o3(e3);
              ...
              case w:
                return function(e4, t4, r4) {
                  return L(t4 ? r4(z(e4), true) : z(e4), q, new e4.constructor());
                }(e3, n3, r3);
              case $:
                return function(e4) {
      ...
      return u2 || (s2.set(r2, a2), function(e3, t3) {
        ...
        h2 && (e3 = r2[t3 = e3]), ye(a2, t3, me(e3, n2, o2, i2, t3, r2, s2));
      }), a2);
    }
    function _e(e2) {
      var t2;
      return Re(e2) && (t2 = e2, !(W && W in t2)) && (Pe(e2) || U(e2) ? Y : i).test(Ee(e2));
    }
    function je(e2) {
    ...
    function we(e2, t2, r2, n2) {
      r2 = r2 || {};
      for (var o2 = -1, i2 = t2.length; ++o2 < i2; ) {
  ...
  function deepAssign(t, ...r) {
    const i = {array: false, object: true, cloneChilds: true};
    var e = r[r.length - 1] || {};
    (e.array && typeof e.array == "boolean" || e.object && typeof e.object == "boolean") && (e.array !== void 0 && (i.array = e.array), e.object !== void 0 && (i.object = e.object), r.pop());
    for (let e2 = 0; e2 < r.length; e2++)
      !function e3(t2, r2) {
        for (const o of Object.keys(r2)) {
          var n;
          i.array === true && Array.isArray(t2[o]) && Array.isArray(r2[o]) ? (n = unique$1([...t2[o], ...r2[o]]), t2[o] = n) : i.object === true && plainObject$1(t2[o]) && plainObject$1(r2[o]) ? t2[o] = e3(t2[o], r2[o]) : plainObject$1(r2[o]) && i.cloneChilds ? t2[o] = clone(r2[o], {deep: true}) : t2[o] = r2[o];
        }
        return t2;
      }(t, r[e2] || {});
    return t;
  ...
  function deepMerge$1(...t) {
    ...
    for (let e2 = 0; e2 < t.length; e2++) {
      ...
      r = function e3(t2, r2) {
        ...
        for (const i of Object.keys(r2)) {
          var o;
          s.array === true && Array.isArray(t2[i]) && Array.isArray(r2[i]) ? (o = unique$1([...t2[i], ...r2[i]]), n2[i] = o) : s.object === true && plainObject$1(t2[i]) && plainObject$1(r2[i]) ? n2[i] = e3(t2[i], r2[i]) : copyTo(r2).pick(i).toCover(n2);
        }
        return n2;
      }(r, n);
    }
  ...
  Copy.prototype.withAccess = function(e) {
    ...
    if (!this._withAccess) {
      for (var r = 0; r < t.length; r++)
        e[i = t[r]] === void 0 && (e[i] = this.src[i]);
      return e;
    }
    for (r = 0; r < t.length; r++) {
      var n, o, i = t[r];
      notDefined(e, i) && (n = this.src.__lookupGetter__(i), o = this.src.__lookupSetter__(i), n && e.__defineGetter__(i, n), o && e.__defineSetter__(i, o), n || o || (e[i] = this.src[i]));
    }
    return e;
    ...
    for (var t = this.keys || Object.keys(this.src), r = 0; r < t.length; r++) {
      ...
      o && e.__defineGetter__(n, o), i && e.__defineSetter__(n, i), o || i || (e[n] = this.src[n]);
    }
  ...
  var md5$1 = {exports: {}}, core = {exports: {}}, __viteBrowserExternal = {}, __viteBrowserExternal$1 = Object.freeze({__proto__: null, [Symbol.toStringTag]: "Module", default: __viteBrowserExternal}), require$$0 = getAugmentedNamespace(__viteBrowserExternal$1), Di;
  core.exports = function(l) {
    ...
    var e = {}, o = e.lib = {}, i = o.Base = {extend: function(e2) {
      var t2 = r(this);
    ...
    }}, u = o.WordArray = i.extend({init: function(e2, t2) {
      ...
      if (this.clamp(), n2 % 4)
        for (var i2 = 0; i2 < o2; i2++) {
          var s2 = r2[i2 >>> 2] >>> 24 - i2 % 4 * 8 & 255;
          t2[n2 + i2 >>> 2] |= s2 << 24 - (n2 + i2) % 4 * 8;
        }
      else
        for (i2 = 0; i2 < o2; i2 += 4)
          t2[n2 + i2 >>> 2] = r2[i2 >>> 2];
      ...
      for (var t2 = e2.words, r2 = e2.sigBytes, n2 = [], o2 = 0; o2 < r2; o2++) {
        var i2 = t2[o2 >>> 2] >>> 24 - o2 % 4 * 8 & 255;
        n2.push((i2 >>> 4).toString(16)), n2.push((15 & i2).toString(16));
      }
      return n2.join("");
    }, parse: function(e2) {
      ...
      for (var t2 = e2.words, r2 = e2.sigBytes, n2 = [], o2 = 0; o2 < r2; o2++) {
        var i2 = t2[o2 >>> 2] >>> 24 - o2 % 4 * 8 & 255;
        n2.push(String.fromCharCode(i2));
      }
      return n2.join("");
    }, parse: function(e2) {
    ...
    }}, h = o.BufferedBlockAlgorithm = i.extend({reset: function() {
      this._data = new u.init(), this._nDataBytes = 0;
    }, _append: function(e2) {
      typeof e2 == "string" && (e2 = f.parse(e2)), this._data.concat(e2), this._nDataBytes += e2.sigBytes;
    }, _process: function(e2) {
      var t2, r2 = this._data, n2 = r2.words, o2 = r2.sigBytes, i2 = this.blockSize, s2 = o2 / (4 * i2), a2 = (s2 = e2 ? l.ceil(s2) : l.max((0 | s2) - this._minBufferSize, 0)) * i2, o2 = l.min(4 * a2, o2);
      if (a2) {
        for (var c2 = 0; c2 < a2; c2 += i2)
    ...
    o.Hasher = h.extend({cfg: i.extend(), init: function(e2) {
    ...
    var p = e.algo = {};
    return e;
  }(Math), md5$1.exports = (Di = core.exports, function(c) {
    var e = Di, t = e.lib, r = t.WordArray, n = t.Hasher, t = e.algo, O = [];
    !function() {
    ...
    function x(e2, t2, r2, n2, o, i, s) {
      s = e2 + (t2 & r2 | ~t2 & n2) + o + s;
      return (s << i | s >>> 32 - i) + t2;
    }
    function E(e2, t2, r2, n2, o, i, s) {
      s = e2 + (t2 & n2 | r2 & ~n2) + o + s;
      return (s << i | s >>> 32 - i) + t2;
    }
    function A(e2, t2, r2, n2, o, i, s) {
      s = e2 + (t2 ^ r2 ^ n2) + o + s;
      return (s << i | s >>> 32 - i) + t2;
    }
    function M(e2, t2, r2, n2, o, i, s) {
      s = e2 + (r2 ^ (t2 | ~n2)) + o + s;
      return (s << i | s >>> 32 - i) + t2;
    }
  ...
  convert$1.rgb.hsl = function(e) {
    var t = e[0] / 255, r = e[1] / 255, n = e[2] / 255, o = Math.min(t, r, n), i = Math.max(t, r, n), e = i - o;
    let s, a;
    i === o ? s = 0 : t === i ? s = (r - n) / e : r === i ? s = 2 + (n - t) / e : n === i && (s = 4 + (t - r) / e), s = Math.min(60 * s, 360), s < 0 && (s += 360);
    r = (o + i) / 2;
    return a = i === o ? 0 : r <= 0.5 ? e / (i + o) : e / (2 - i - o), [s, 100 * a, 100 * r];
  }, convert$1.rgb.hsv = function(e) {
    var t;
    let r, n;
    var o = e[0] / 255, i = e[1] / 255, s = e[2] / 255;
    const a = Math.max(o, i, s), c = a - Math.min(o, i, s);
    var l = function(e2) {
      return (a - e2) / 6 / c + 0.5;
    };
    return c == 0 ? (r = 0, n = 0) : (n = c / a, t = l(o), e = l(i), l = l(s), o === a ? r = l - e : i === a ? r = 1 / 3 + t - l : s === a && (r = 2 / 3 + e - t), r < 0 ? r += 1 : 1 < r && --r), [360 * r, 100 * n, 100 * a];
    ...
    if (t)
      return t;
    let r = 1 / 0, n;
    for (const i of Object.keys(cssKeywords)) {
      var o = comparativeDistance(e, cssKeywords[i]);
      o < r && (r = o, n = i);
    }
    return n;
    ...
    let n, o, i;
    if (r == 0)
      return i = 255 * e, [i, i, i];
    n = e < 0.5 ? e * (1 + r) : e + r - e * r;
    var s = 2 * e - n;
    const a = [0, 0, 0];
    for (let e2 = 0; e2 < 3; e2++)
      o = t + 1 / 3 * -(e2 - 1), o < 0 && o++, 1 < o && o--, i = 6 * o < 1 ? s + 6 * (n - s) * o : 2 * o < 1 ? n : 3 * o < 2 ? s + (n - s) * (2 / 3 - o) * 6 : s, a[e2] = 255 * i;
    return a;
    ...
    var t = e[0] / 60, r = e[1] / 100, n = e[2] / 100, e = Math.floor(t) % 6, t = t - Math.floor(t), o = 255 * n * (1 - r), i = 255 * n * (1 - r * t), s = 255 * n * (1 - r * (1 - t));
    switch (n *= 255, e) {
      case 0:
        return [n, s, o];
      case 1:
    ...
    let n, o, i;
    return n = 3.2406 * t + -1.5372 * r + -0.4986 * e, o = -0.9689 * t + 1.8758 * r + 0.0415 * e, i = 0.0557 * t + -0.204 * r + 1.057 * e, n = 31308e-7 < n ? 1.055 * __pow(n, 1 / 2.4) - 0.055 : 12.92 * n, o = 31308e-7 < o ? 1.055 * __pow(o, 1 / 2.4) - 0.055 : 12.92 * o, i = 31308e-7 < i ? 1.055 * __pow(i, 1 / 2.4) - 0.055 : 12.92 * i, n = Math.min(Math.max(0, n), 1), o = Math.min(Math.max(0, o), 1), i = Math.min(Math.max(0, i), 1), [255 * n, 255 * o, 255 * i];
    ...
    let n, o, i;
    o = (t + 16) / 116, n = r / 500 + o, i = o - e / 200;
    t = __pow(o, 3), r = __pow(n, 3), e = __pow(i, 3);
    return o = 8856e-6 < t ? t : (o - 16 / 116) / 7.787, n = 8856e-6 < r ? r : (n - 16 / 116) / 7.787, i = 8856e-6 < e ? e : (i - 16 / 116) / 7.787, n *= 95.047, o *= 100, i *= 108.883, [n, o, i];
    ...
    if ((t = Math.round(t / 50)) === 0)
      return 30;
    let i = 30 + (Math.round(o / 255) << 2 | Math.round(n / 255) << 1 | Math.round(r / 255));
    return t === 2 && (i += 60), i;
    ...
    var t = e[0] / 255, r = e[1] / 255, n = e[2] / 255, o = Math.max(Math.max(t, r), n), i = Math.min(Math.min(t, r), n), e = o - i;
    let s, a;
    return s = e < 1 ? i / (1 - e) : 0, a = e <= 0 ? 0 : o === t ? (r - n) / e % 6 : o === r ? 2 + (n - t) / e : 4 + (t - r) / e, a /= 6, a %= 1, [360 * a, 100 * e, 100 * s];
  ...
  function deriveBFS(e) {
    ...
    for (r[e].distance = 0; n.length; ) {
      var o = n.pop(), i = Object.keys(conversions$1[o]);
      for (let e2 = i.length, t = 0; t < e2; t++) {
        var s = i[t];
        const a = r[s];
  ...
  var route$1 = function(e) {
    ...
    for (let e2 = o.length, t = 0; t < e2; t++) {
      var i = o[t];
      r[i].parent !== null && (n[i] = wrapConversion(i, r));
    }
    return n;
  };
  ...
  !function() {
    ...
    const p = (e, t, r, n) => {
      ...
      var o, i, s2 = n ? 10 : 0;
      const a2 = {};
      for ([o, i] of Object.entries(h)) {
        var c2 = o === "ansi16" ? "ansi" : o;
        o === t ? a2[c2] = e(r, s2) : typeof i == "object" && (a2[c2] = e(i[t], s2));
      }
      return a2;
    };
    Object.defineProperty(ansiStyles$1, "exports", {enumerable: true, get: function() {
      ...
      for (var [r, n] of Object.entries(t)) {
        for (var [o, i] of Object.entries(n))
          t[o] = {open: `[${i[0]}m`, close: `[${i[1]}m`}, n[o] = t[o], e.set(i[0], i[1]);
  ...
  const stringReplaceAll$1 = (e, t, r) => {
    ...
    var o = t.length;
    let i = 0, s = "";
    for (; s += e.substr(i, n - i) + t + r, i = n + o, n = e.indexOf(t, i), n !== -1; )
      ;
  ...
  function parseArguments(e, t) {
    const r = [];
    let n;
    for (const i of t.trim().split(/\s*,\s*/g)) {
      var o = Number(i);
      if (Number.isNaN(o)) {
        if (!(n = i.match(STRING_REGEX)))
  ...
  var templates = (s, e) => {
    const a = [], c = [];
    let l = [];
    if (e.replace(TEMPLATE_REGEX, (e2, t, r, n, o, i) => {
      if (t)
        l.push(unescape$1(t));
      else if (n) {
        t = l.join("");
    ...
    return Object.keys(r).forEach((e) => {
      if (o.privateProps || !e.match(/^_/))
        if (plainObject$1(r[e]) || classInstance(r[e]) && o.classInstances || Array.isArray(r[e]) && o.array) {
          const t = deepMap(r[e], n, o, [...i, e]);
          s ? a.push(t) : a[e] = t;
        } else {
          const t = n({object: r, prop: e, value: r[e], path: [...i, e].join(".")});
  ...
  function isJson(e) {
    try {
      var t = JSON.parse(e);
      return Object.keys(t).length ? 1 : void 0;
    } catch (e2) {
      return;
    }
    return 1;
  ...
  function fn$1(r, n = {}) {
    ...
    if (r !== void 0) {
      if (r instanceof Error) {
        var e = r.toString();
        const o = r.stack, i = r.message;
        return n.verbose ? [`<red>${r.constructor.name || "Error"}</red>`, "", i, "", o].join("\n") : e;
      }
  ...
  var __set = (t, r, n, e = {}) => {
    if (e = Object.assign({}, e), r && r !== "" && r !== ".") {
      const i = unquote(r = r.replace(/\[(\w+)\]/g, ".[$1]")).split(/(?!\B"[^"]*)\.(?![^"]*"\B)/gm).map((e3) => unquote(e3));
      let e2 = t;
      for (; i.length - 1; ) {
        var o = i.shift();
        o in e2 || (i[0].match(/^\[[0-9]+\]$/) ? e2[o] = [] : e2[o] = {}), e2 = e2[o];
      }
      return i[0].match(/^\[[0-9]+\]$/) ? (Array.isArray(e2) || (e2 = []), e2.push(n)) : e2[i[0]] = n, get(t, r);
    }
    t = n;
  };
  function toJson(e) {
  ...
  function getInterfaceObj(t, r) {
    ...
    if (!n) {
      ...
      for (let e = 0; e < o.length; e++) {
        var i = t._interfacesStack[o[e]];
        if (i[r] !== void 0) {
          n = plainObject$1(i[r]) ? i[r] : {apply: true, on: r === "settings" ? "_settings" : r === "this" ? t : void 0, class: i[r]};
          break;
        }
      }
    }
  ...
  function applyInterface(n, o, e = null) {
    ...
    if (e !== void 0 && (i.on = e), !i)
      throw `Sorry the the asked interface "<yellow>${o}</yellow>" does not exists on the class "<cyan>${n.constructor.name}</cyan>"`;
    if (o.includes(".") && (o = o.split(".").slice(1).join(".")), plainObject$1(i)) {
      let e2;
      e2 = i.on && typeof i.on == "string" ? get(n, i.on) : i.on && typeof i.on == "object" ? i.on : get(n, o);
      let t = n.constructor.name;
      n.id && (t += `(${n.id})`), o && (t += `.${o}`), i.on && i.on.constructor && (t += `.${i.on.constructor.name}`), i.on && i.on.id && (t += `(${i.on.id})`);
      let r;
      return o === "this" ? (r = i.class.apply(e2 || {}, {id: t, complete: true, throw: true}), deepAssign(n, r.value), n) : (r = i.class.apply(e2, {id: t, complete: true, throw: true}), i.on && typeof i.on == "object" ? deepAssign(i.on, r.value) : i.on && typeof i.on == "string" ? deepAssign(get(n, i.on), r.value) : n[o] !== void 0 ? n[o] : r.hasIssues() ? void 0 : r.value);
    }
  }
  ...
  function range(e, t, r) {
    var n, o, i, s, a, c = r.indexOf(e), l = r.indexOf(t, c + 1), u = c;
    if (0 <= c && 0 < l) {
      if (e === t)
        return [c, l];
      for (n = [], i = r.length; 0 <= u && !a; )
        u == c ? (n.push(u), c = r.indexOf(e, u + 1)) : n.length == 1 ? a = [n.pop(), l] : ((o = n.pop()) < i && (i = o, s = l), l = r.indexOf(t, u + 1)), u = c < l && 0 <= c ? c : l;
      n.length && (a = [i, s]);
    }
    return a;
  }
  ...
  function expand$1(e, t) {
    ...
    if (!n || /\$$/.test(n.pre))
      return [e];
    var o = /^-?\d+\.\.-?\d+(?:\.\.-?\d+)?$/.test(n.body), i = /^[a-zA-Z]\.\.[a-zA-Z](?:\.\.-?\d+)?$/.test(n.body), s = o || i, o = 0 <= n.body.indexOf(",");
    if (!s && !o)
    ...
    if (s) {
      ...
      for (var d, v, g = a.some(isPadded), y = [], b = e; p(b, u); b += h)
        i ? (v = String.fromCharCode(b)) === "\\" && (v = "") : (v = String(b), !g || 0 < (d = f - v.length) && (d = new Array(1 + d).join("0"), v = b < 0 ? "-" + d + v.slice(1) : d + v)), y.push(v);
    } else
  ...
  function parse(e, t) {
    ...
    if (e === "")
      return "";
    var n, o = "", i = !!r.nocase, s = false, a = [], c = [], l = false, u = -1, f = -1, h = e.charAt(0) === "." ? "" : r.dot ? "(?!(?:^|\\/)\\.{1,2}(?:$|\\/))" : "(?!\\.)", p = this;
    function d() {
      if (n) {
        switch (n) {
          case "*":
    ...
    for (l && (m = e.substr(f + 1), _ = this.parse(m, SUBPARSE), o = o.substr(0, u) + "\\[" + _[0], i = i || _[1]), b = a.pop(); b; b = a.pop()) {
      ...
      i = true, o = o.slice(0, b.reStart) + w + "\\(" + j;
    }
    d(), s && (o += "\\\\");
    var S = false;
    switch (o.charAt(0)) {
  ...
  function match(e, t) {
    ...
    var n, o, i = this.set;
    for (this.debug(this.pattern, "set", i), o = e.length - 1; 0 <= o && !(n = e[o]); o--)
      ;
  ...
  class SEventEmitter extends SClass {
    ...
    static pipe(o, i, e) {
      ...
      o.on(s.events || "*", (r, n) => __awaiter$1(this, void 0, void 0, function* () {
        ...
        if (!n.event.match(/^answer\..*/) && ((!s.exclude || s.exclude.indexOf(n.event) === -1) && (!s.filter || s.filter(r, n)) && (s.stripAnsi && (r && r.value && typeof r.value == "string" ? r.value = stripAnsi(r.value) : typeof r == "string" && (r = stripAnsi(r))), s.trim && (r && r.value && typeof r.value == "string" ? r.value = r.value.trim() : typeof r == "string" && (r = r.trim())), s.keepLineBreak === false && (r && r.value && typeof r.value == "string" ? r.value = r.value.replace(/\r?\n|\r/g, "") : typeof r == "string" && (r = r.replace(/\r?\n|\r/g, ""))), s.processor && (e2 = s.processor(r, n), Array.isArray(e2) && e2.length === 2 ? (r = e2[0], n = e2[1]) : typeof e2 == "object" && e2.value !== void 0 && e2.metas !== void 0 ? (r = e2.value, n = e2.metas) : r = e2), s.prefixValue && (r && r.value && typeof r.value == "string" ? r.value = `${s.prefixValue}${r.value}` : typeof r == "string" && (r = `${s.prefixValue}${r}`)), n && n.event))) {
          let e3 = n.event;
          n.emitter || (n.emitter = this), s.prefixEvent && (e3 = typeof s.prefixEvent == "string" ? `${s.prefixEvent}.${n.event}` : `${n.name}`, n.event = e3), n.askId && i.on(`${n.event}:1`, (e4, t2) => {
            o.emit(`answer.${n.askId}`, e4);
          });
          const t = Object.assign(Object.assign({}, n), {level: n && n.level ? n.level + 1 : 1});
          s.overrideEmitter === "bind" && i.eventEmitterSettings.bind ? t.emitter = i.eventEmitterSettings.bind : s.overrideEmitter === true && (t.emitter = i), i.emit(n.event, r, t);
        }
      }));
    }
    ...
    _emitEventStack(a, c, l) {
      ...
      return __awaiter$1(this, void 0, void 0, function* () {
        ...
        let i = deepMerge$1({event: a, name: a, emitter: (u = (u = this.eventEmitterSettings.bind) !== null && u !== void 0 ? u : l == null ? void 0 : l.emitter) !== null && u !== void 0 ? u : this, originalEmitter: (u = l == null ? void 0 : l.originalEmitter) !== null && u !== void 0 ? u : this, time: Date.now(), level: 1, id: uniqid()}, l);
        for (let e2 = 0; e2 < r.length; e2++) {
          const s = r[e2];
          if (!s.callback)
            return t;
          s.filter && !s.filter(t, i) || (s.processor && (n = s.processor(t, i), Array.isArray(n) && n.length === 2 ? (t = n[0], i = n[1]) : typeof n == "object" && n.value !== void 0 && n.metas !== void 0 ? (t = n.value, i = n.metas) : t = n), (n = yield s.callback(t, i)) !== void 0 && (t = n));
        }
        return !r.length && i.askId && this.emit(`answer.${i.askId}`, t), t;
      });
    }
    _emitEvents(n, o, i) {
      return new Promise((e, t) => __awaiter$1(this, void 0, void 0, function* () {
        ...
        for (let e2 = 0; e2 < n.length; e2++) {
          var r = yield this._emitEventStack(n[e2], t2, i);
          r !== void 0 && (t2 = r);
        }
        e(t2);
      }));
  ...
  function deepMerge(...t) {
    ...
    for (let e2 = 0; e2 < t.length; e2++) {
      ...
      r = function e3(t2, r2) {
        ...
        for (const i of Object.keys(r2)) {
          var o;
          s.array === true && Array.isArray(t2[i]) && Array.isArray(r2[i]) ? (o = unique([...t2[i], ...r2[i]]), n2[i] = o) : s.object === true && plainObject(t2[i]) && plainObject(r2[i]) ? n2[i] = e3(t2[i], r2[i]) : copyTo(r2).pick(i).toCover(n2);
        }
        return n2;
      }(r, n);
    }
      ...
      _observer || (_observer = new MutationObserver((e2) => {
        ...
        e2.forEach((t2) => {
          if (t2.addedNodes && t2.addedNodes.length)
            ...
            const e3 = Object.keys(_selectors);
            e3.forEach((e4) => {
              matches(t2.target, e4) && i(t2.target, e4, n2);
            });
          }
        });
    ...
    return t.forEach((t2) => {
      if (t2.slice(0, 1) != "@") {
        ...
        if (e2.length === 1) {
          ...
          const n = e2[0];
          let r = n;
          i !== "" && (r = n + i), o.push(r), e2.forEach((e3, t3) => {
            0 < t3 && (r = n + "--" + e3, i !== "" && (r += i), o.push(r));
          });
        }
      } else
        i = t2.replace("@", "___");

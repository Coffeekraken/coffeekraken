        ...
        <form>
          <ul class="__settings s-bg:odd">
            <li class="s-bg:main-surface">
              <label class="s-label s-pi:40 s-pb:30" for="theme-switcher">
                <span> Dark mode </span>
                <input
            ...
            <li class="s-bg:main-surface">
              <label class="s-label s-pi:40 s-pb:30" for="setting-base-color">
            ...
            <li class="s-bg:main-surface">
              <label class="s-label s-pi:40 s-pb:30" for="setting-main-color">
            ...
            <li class="s-bg:main-surface">
              <label class="s-label s-pi:40 s-pb:30" for="setting-accent-color">
            ...
            <li class="s-bg:main-surface">
              <label class="s-label s-pi:40 s-pb:30" for="setting-font-size">
                Document scale
                <s-range

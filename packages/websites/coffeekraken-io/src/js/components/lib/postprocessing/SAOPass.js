...
export default function (THREE) {
    THREE.SAOPass = function (
        ...
        this.supportsNormalTexture =
            useNormals !== undefined ? useNormals : false;
        ...
        if (THREE.DepthLimitedBlurShader === undefined) {
            console.error(
                'THREE.SAOPass relies on THREE.DepthLimitedBlurShader',
            );
        }
        ...
        if (THREE.CopyShader === undefined) {
            console.error(
                'THREE.SAOPass relies on THREE.UnpackDepthRGBAShader',
            );
        }
    ...
    THREE.SAOPass.prototype = Object.assign(
        Object.create(THREE.Pass.prototype),
        {
            ...
            render: function (
                ...
                this.saoMaterial.uniforms['intensity'].value =
                    this.params.saoIntensity;
                ...
                this.params.saoBlurRadius = Math.floor(
            ...
            renderPass: function (
                ...
                renderer.autoClear = false;
                var clearNeeded =
                    clearColor !== undefined && clearColor !== null;
                if (clearNeeded) {

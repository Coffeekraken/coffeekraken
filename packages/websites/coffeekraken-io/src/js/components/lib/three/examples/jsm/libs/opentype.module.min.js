                        ...
                        for (s = 0; s < e.glyphs.length; s += 1)
                            (l = e.glyphs.get(s)),
                                e.cffEncoding
                                    ...
                                    : e.glyphNames.names &&
                                      (l.name = e.glyphNames.glyphIndexToName(
                                          s,
                                      ));
                    }
                ...
                function (require, module, exports) {
                    ...
                    (Font.prototype.hasChar = function (e) {
                        ...
                        (Font.prototype.getPath = function (e, t, n, i, r) {
                            var o = new path.Path();
                            return (
                                this.forEachGlyph(e, t, n, i, r, function (
                                    e,
                                    t,
                                    n,
                                    i,
                        ...
                        (Font.prototype.drawPoints = function (
                            ...
                            this.forEachGlyph(t, n, i, r, o, function (
                                t,
                                n,
                                i,
                                r,
                ...
                function (require, module, exports) {
                    ...
                    (encode.BYTE = function (e) {
                        ...
                        (encode.REAL = function (e) {
                            var n = e.toString(),
                                t = /\.(\d*?)(?:9{5,20}|0{5,20})\d{0,2}(?:e(.+)|$)/.exec(
                                    n,
                                );
                            if (t) {
                                var o = parseFloat(

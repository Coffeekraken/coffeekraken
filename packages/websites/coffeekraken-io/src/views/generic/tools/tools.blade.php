        ...
        <div s-floating placement="left" class="s-tooltip:interactive s-text:center">
            <div class="s-position:relative">
                ...
                <a class="s-btn s-color:complementary s-display:block"
                    ...
                    title="Coffeekraken on Discord" target="_blank">
    ...
    <div class="tools__share s-tooltip-container">
        ...
        <div s-floating placement="left" class="s-tooltip:interactive s-text:center">
            <div class="s-position:relative">
                ...
                <p class="s-typo:p s-font:30 s-mbe:30">
                    <span class="s-tc:accent">The more we are</span>, the stronger we become.
                    <br />
    ...
    <div class="tools__share s-tooltip-container">
        ...
        <div s-floating placement="left" class="s-tooltip:interactive s-text:center">
            <div class="s-position:relative">
                ...
                <a class="s-btn s-color:complementary s-display:block"
                    href="https://discord.com/channels/940362961682333767/940362962223378494" title="Join us on Discord"
                    target="_blank">
        ...
        <div s-floating placement="left" class="s-tooltip:interactive s-text:center">
            <div class="s-position:relative">
                ...
                <a class="s-btn s-color:accent s-display:block" href="https://github.com/Coffeekraken/coffeekraken"
                    title="Coffeekraken is 100% open sourced" target="_blank">
                    <i class="s-icon:github"></i> Discover our codebase!
                </a>
            </div>
        </div>
    </div>

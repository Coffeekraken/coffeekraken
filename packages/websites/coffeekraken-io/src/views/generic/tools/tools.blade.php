<div class="tools">
    ...
    <div class="tools__share s-tooltip-container">
        ...
        <div class="s-tooltip:inline-start:interactive:wrap:discord s-text:center">
            <div class="s-position:relative">
                ...
                <a href="https://www.facebook.com/sharer/sharer.php?u=#url" class="s-btn:block s-color:accent s-mbe:20" title="Share the love" target="_blank">
                    <i class="s-icon:facebook s-font:50 s-mi:10"></i> Share on Facebook!
                </a>
                <a href="https://twitter.com/intent/tweet?url=" class="s-btn:block s-color:complementary" title="Share the love" target="_blank">
    ...
    <div class="tools__share s-tooltip-container">
        <a class="s-btn:block s-color:complementary" href="https://olivierbossel.com" title="Share the love" target="_blank">

<header id="header" class="s-container">
    ...
    <div class="s-flex:align-center" style="position: relative">
        ...
        <form class="s-flex-item:order-10" name="search" id="search-form">
            ...
            <s-filtrable-input id="search-input" filtrable="name,namespace,status" value="namespace" interactive not-selectable default-style>
                ...
                <template id="item">
                    ...
                    <div class="s-flex">
                        <div style="width:40%" class="s-pd:50">
                            ...
                            <p class="s-p s-mb:30">@{{description}}</p>
                            <a href="/doc/@{{namespace}}.@{{name}}" class="s-btn:accent">
                                Check out more
                            </a>
                        </div>
                        @{{#if example}}

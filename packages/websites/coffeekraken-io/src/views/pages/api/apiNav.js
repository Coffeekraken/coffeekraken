...
export class ApiNav extends __SLitComponent {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.addEventListener('actual', (e) => {
                for (let [key, value] of Object.entries(this._menuStates)) {
                    if (
                        e.target.getAttribute('namespace').startsWith(key + '.')
                    ) {
                        value.opened = true;
                    }
                }
            ...
            this._menuStates = JSON.parse(
                (_a = window.localStorage.getItem('apiNavStates')) !== null &&
                    _a !== void 0
                    ? _a
                    : '{}',
            );
            ...
            res.data.map = __filter(res.data.map, (key, item) => {
                ...
                let type =
                    (_d =
                        (_c =
                            (_b =
                                (_a = item.type) === null || _a === void 0
                                    ? void 0
                                    : _a.types) === null || _b === void 0
                                ? void 0
                                : _b[0]) === null || _c === void 0
                            ? void 0
    ...
    _isAcive(namespace) {
        var _a;
        return (_a = this._menuStates[namespace]) === null || _a === void 0
            ? void 0
            : _a.opened;
    }
    _toggle(namespace) {
...
__decorate([property()], ApiNav.prototype, '_loaded', void 0);
(() => {

            ...
            <div class="s-container">
                ...
                <div class="s-bg:main-surface s-scale:15 s-radius s-depth:100 s-mbe:50">
                    <ul class="s-tabs:grow s-color:complementary">
                        <li s-activate href="#homepage-discover-js" id="homepage-discover-js-tab" group="homepage-discover" active save-state>
                            <i class="s-icon:lang-js s-mie:20"></i>JS
                        </li>
                        <li s-activate href="#homepage-discover-node" id="homepage-discover-node-tab" group="homepage-discover" save-state>
                            <i class="s-icon:lang-js s-mie:20"></i>Node
                        </li>
                        <li s-activate href="#homepage-discover-css" id="homepage-discover-css-tab" group="homepage-discover" save-state>
                            <i class="s-icon:lang-css s-mie:20"></i>CSS
                        </li>
                        <li s-activate href="#homepage-discover-php" id="homepage-discover-php-tab" group="homepage-discover" save-state>

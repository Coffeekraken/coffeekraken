...
sugar init --recipe riotComponent
            ...
            <ul class="__recipes-grid">
                @foreach (['complementary','accent','complementary','accent'] as $i)
                <li>
        ...
        <div>
            ...
            <p class="s-typo:p-lead s-mb:30">
                <span class="s-color:accent">Recipe</span> is the term used by Coffeekraken to define <span class="s-color:complementary">project template</span>.
            </p>
            <p class="s-typo:p">

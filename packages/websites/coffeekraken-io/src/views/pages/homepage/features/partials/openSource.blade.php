            ...
            <div class="s-layout:1112 s-position:relative">
                <div class="s-depth:text">
                    ...
                    <p class="s-typo:lead s-mbe:50">
                        Note that this project is all open source. This mean that <span class="s-tc:complementary">it
                            needs your support</span> as well as <span class="s-tc:accent">your good
                            thoughts</span>. Don't hesitate to joins us to make it even better!
                    </p>

                    <a class="s-btn s-color:complementary s-mie:20">

<section id="features-webcomponents" class="s-pb:100" s-appear in="bottom">
        ...
        <div class="s-layout:122:gap-x:gap-between">
            ...
            <div>
                ...
                <p class="s-typo:p s-mbe:40">
                    Some features are clearly missing in our web browsers these days like a searchable/filtrable select
                    input for example.
                    In order to help with that, Coffeekraken provide some fully customisable and framework agnostic
                    webcomponents that you can

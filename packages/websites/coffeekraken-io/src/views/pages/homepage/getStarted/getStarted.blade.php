    ...
    <div class="s-grid:12 s-container">
        <div>
            ...
            <p class="s-typo:p s-mbe:50">
                ...
                the <span class="s-color:accent">full production build process</span> as well as the <span class="s-color:accent">complete documentation stack</span>.
            </p>
        </div>
        <div>
           <ul class="__tabs s-tabs:vertical">
                <li class="s-p:30">
                    <div class="s-flex">
                        ...
                        <div>
                            <i class="s-color:accent s-icon:vue"></i>

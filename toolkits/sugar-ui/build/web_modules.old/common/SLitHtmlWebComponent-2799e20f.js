import { a as commonjsGlobal, c as createCommonjsModule, g as getDefaultExportFromCjs, d as deepMerge_1, p as plainObject_1 } from './deepMerge-7574b276.js';
import { S as SPromise_1, p as path, t as toString_1, n as node, a as parseHtml_1, b as SError_1, g as get, u as uniqid_1, _ as _delete, c as global, s as set, d as parse$3 } from './SPromise-ce34924b.js';
import { p as process } from './process-2545f00a.js';
import { a as autoCast_1, c as convert_1 } from './autoCast-024d218e.js';
...
var on = function on(name, callback) {
  ...
  if (!commonjsGlobal._sugarEventSPromise) commonjsGlobal._sugarEventSPromise = new SPromise_1({
    id: 'sugarEventSPromise'
  }); // subscribe to the event

  commonjsGlobal._sugarEventSPromise.on(name, callback); // return the unsubscribe function


  return () => {
    commonjsGlobal._sugarEventSPromise.off(name, callback);
  };
};
...
var _lodash = _interopRequireDefault(lodash_clone);

var _lodash2 = _interopRequireDefault(lodash_clonedeep);
...
var __clone = /*@__PURE__*/getDefaultExportFromCjs(clone_1);
...
var observeAttributes = createCommonjsModule(function (module, exports) {
...
var _SPromise = _interopRequireDefault(SPromise_1);
...
var whenAttribute_1 = createCommonjsModule(function (module, exports) {
...
var _autoCast = _interopRequireDefault(autoCast_1);

var _observeAttributes = _interopRequireDefault(observeAttributes);
...
var inViewport_1 = inViewport;

var instances = [];
var supportsMutationObserver = typeof commonjsGlobal.MutationObserver === 'function';

function inViewport(elt, params, cb) {
  var opts = {
    container: commonjsGlobal.document.body,
    offset: 0,
    debounce: 15,
    failsafe: 150
  };
...
var contains = function() {
  ...
  return commonjsGlobal.document.documentElement.compareDocumentPosition ?
    function (a, b) {
      return !!(a.compareDocumentPosition(b) & 16);
    } :
    commonjsGlobal.document.documentElement.contains ?
      function (a, b) {
...
function createInViewport(container, debounceValue, failsafe) {
  ...
  var scrollContainer = container === commonjsGlobal.document.body ? commonjsGlobal : container;
  var debouncedCheck = debounce(watches.checkAll(watchInViewport), debounceValue);

  addEvent(scrollContainer, 'scroll', debouncedCheck);

  if (scrollContainer === commonjsGlobal) {
    addEvent(commonjsGlobal, 'resize', debouncedCheck);
  }
  ...
  function isVisible(elt, offset) {
    ...
    if (!contains(commonjsGlobal.document.documentElement) || !contains(commonjsGlobal.document.documentElement)) {
      return false;
    }
    ...
    if (container === commonjsGlobal.document.body) {
      viewport = {
        top: -offset,
        left: -offset,
        right: commonjsGlobal.document.documentElement.clientWidth + offset,
        bottom: commonjsGlobal.document.documentElement.clientHeight + offset
      };
    } else {
...
var whenInViewport_1 = createCommonjsModule(function (module, exports) {
...
var _inViewport = _interopRequireDefault(inViewport_1);
...
var whenOutOfViewport_1 = createCommonjsModule(function (module, exports) {
...
var _isInViewport2 = _interopRequireDefault(isInViewport_1);
...
var getStyleProperty_1 = createCommonjsModule(function (module, exports) {
...
var _camelize = _interopRequireDefault(camelize_1);
...
var getTransitionProperties_1 = createCommonjsModule(function (module, exports) {
...
var _getStyleProperty = _interopRequireDefault(getStyleProperty_1);

var _convert = _interopRequireDefault(convert_1);
...
var whenTransitionEnd_1 = createCommonjsModule(function (module, exports) {
...
var _getTransitionProperties = _interopRequireDefault(getTransitionProperties_1);
...
var closestNotVisible_1 = createCommonjsModule(function (module, exports) {
...
var _isVisible = _interopRequireDefault(isVisible_1);
...
var whenVisible_1 = createCommonjsModule(function (module, exports) {
...
var _closestNotVisible = _interopRequireDefault(closestNotVisible_1);
...
var when_1 = createCommonjsModule(function (module, exports) {
...
function when($node, state, settings) {
  ...
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(function* (resolve, reject) {
      ...
      switch (state) {
        case 'attribute':
          importPromise = Promise.resolve().then(() => _interopRequireWildcard(whenAttribute_1));
          args = [$node, settings.attribute, settings.checkFn];
          break;

        case 'inViewport':
          importPromise = Promise.resolve().then(() => _interopRequireWildcard(whenInViewport_1));
          args = [$node, settings.offset];
          break;

        case 'outOfViewport':
          importPromise = Promise.resolve().then(() => _interopRequireWildcard(whenOutOfViewport_1));
          args = [$node, settings.offset];
          break;

        case 'transitionEnd':
          importPromise = Promise.resolve().then(() => _interopRequireWildcard(whenTransitionEnd_1));
          args = [$node, settings.callback];
          break;

        case 'visible':
          importPromise = Promise.resolve().then(() => _interopRequireWildcard(whenVisible_1));
          args = [$node, settings.callback];
          break;
...
var paramCase$1 = createCommonjsModule(function (module, exports) {
...
function _default(string) {
  return (0, dist_es2015.paramCase)(string);
}
...
var findPackageJson = function find(root) {
  ...
  return addSymbolIterator({
    ...
    next: function next() {
      ...
      if (__fs.existsSync(file) && (data = parse(__fs.readFileSync(file)))) {
        data.__path = file;
 ...
 * @author 		Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
 */
var packageRoot = function packageRoot(from = process.cwd(), highest = false) {
...
var validateValueOutputString_1 = createCommonjsModule(function (module, exports) {
...
var SValueValidationError_1 = createCommonjsModule(function (module, exports) {
...
var _SError2 = _interopRequireDefault(SError_1);

var _validateValueOutputString = _interopRequireDefault(validateValueOutputString_1);
...
var parseTypeDefinitionString_1 = createCommonjsModule(function (module, exports) {
...
var _upperFirst = _interopRequireDefault(upperFirst_1);
...
function typeOf(value, settings) {
  ...
  var type,
      resultObj = {};
  if (Array.isArray(value)) type = 'Array';else if (value === null) type = 'Null';else if (value === undefined) type = 'Undefined';else if (typeof value === 'string') type = 'String';else if ((0, _integer.default)(value)) type = 'Integer';else if (typeof value === 'number') type = 'Number';else if (typeof value === 'boolean') type = 'Boolean';else if (value instanceof RegExp) type = 'RegExp';else if (settings.customClass && (0, _class$1.default)(value) && value.name) {
  ...
  } else if (!settings.customClass && (0, _class$1.default)(value)) {
    type = 'Class';
...
var typeDefinitionArrayObjectToString_1 = createCommonjsModule(function (module, exports) {
...
var getExtendsStack_1 = createCommonjsModule(function (module, exports) {
...
var ofType_1 = createCommonjsModule(function (module, exports) {
...
var _parseTypeDefinitionString = _interopRequireDefault(parseTypeDefinitionString_1);
...
var _typeof$1 = _interopRequireDefault(_typeof);

var _typeDefinitionArrayObjectToString = _interopRequireDefault(typeDefinitionArrayObjectToString_1);

var _getExtendsStack = _interopRequireDefault(getExtendsStack_1);
...
function ofType(value, argTypeDefinition) {
  ...
  var typeOfValue = (0, _typeof$1.default)(value);
  var issueObj = {
    $received: {
      type: (0, _typeof$1.default)(value, {
        of: true
      }),
      value
    },
    ...
    if (definitionObj.type === 'Array' || definitionObj.type === 'Object') {
      ...
      if (definitionObj.of && (Array.isArray(value) || typeof value === 'object')) {
        ...
        loopOn.forEach(valueIndex => {
          ...
          var typeString = (0, _typeof$1.default)(valueToCheck);
        ...
        if ((0, _class$1.default)(value)) return {
          v: true
        };
      } // Integer
          ...
          else if ((0, _class$1.default)(value) && value.name) {
              if ((0, _typeof$1.default)(value) === definitionObj.type) return {
                v: true
              };
...
var _isValidPath = _interopRequireDefault(isValidPath);
...
var SValidation_1 = createCommonjsModule(function (module, exports) {
  ...
  _createClass(SValidation, null, [{
    ...
    value: function apply() {
      ...
      finalArgs.forEach((arg, i) => {
        ...
        if ((0, _node.default)()) {
          var packageRoot$1 = packageRoot;

          message = message.replace("".concat(packageRoot$1(__dirname), "/"), '');
          message = message.replace("".concat(packageRoot$1(), "/"), '');
        }
      });
      return message;
    }
...
var SRequiredValidation_1 = createCommonjsModule(function (module, exports) {
...
var _SValidation2 = _interopRequireDefault(SValidation_1);
 ...
 * @author 		Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
 */
var isPath = function isPath(path, checkExistence = false) {
  // check if the path is valid or not
...
var SPathValidation_1 = createCommonjsModule(function (module, exports) {
...
var STypeValidation_1 = createCommonjsModule(function (module, exports) {
...
var _ofType = _interopRequireDefault(ofType_1);
...
var SValuesValidation_1 = createCommonjsModule(function (module, exports) {
...
var validateValue_1 = createCommonjsModule(function (module, exports) {
...
var _SValueValidationError = _interopRequireDefault(SValueValidationError_1);
...
var _SRequiredValidation = _interopRequireDefault(SRequiredValidation_1);

var _SPathValidation = _interopRequireDefault(SPathValidation_1);

var _STypeValidation = _interopRequireDefault(STypeValidation_1);

var _SValuesValidation = _interopRequireDefault(SValuesValidation_1);
...
var constructorName_1 = createCommonjsModule(function (module, exports) {
...
var deepMap_1 = createCommonjsModule(function (module, exports) {
...
var deepProxy_1 = createCommonjsModule(function (module, exports) {
...
var _proxy = _interopRequireDefault(proxy_1);

var _deepMap = _interopRequireDefault(deepMap_1);
...
var _constructorName = _interopRequireDefault(constructorName_1);

var _get = _interopRequireDefault(get);

var _set = _interopRequireDefault(set);

var _deepProxy = _interopRequireDefault(deepProxy_1);
...
var _SWatch = _interopRequireDefault(SWatch_1);
...
var uncamelize_1 = createCommonjsModule(function (module, exports) {
...
var getHtmlClassFromTagName_1 = createCommonjsModule(function (module, exports) {
...
var _htmlTagToHtmlClassMap = _interopRequireDefault(htmlTagToHtmlClassMap);
...
var domReady_1 = createCommonjsModule(function (module, exports) {
...
var _domready = _interopRequireDefault(ready);
...
var getTagNameFromHtmlClass = createCommonjsModule(function (module, exports) {
...
var mediaQuery_1 = createCommonjsModule(function (module, exports) {
...
var SMediaQuery_1 = createCommonjsModule(function (module, exports) {
...
var _SPromise2 = _interopRequireDefault(SPromise_1);
...
var SWebComponent = createCommonjsModule(function (module, exports) {
...
var _when = _interopRequireDefault(when_1);

var _camelize = _interopRequireDefault(camelize_1);

var _paramCase = _interopRequireDefault(paramCase$1);

var _validateValue = _interopRequireDefault(validateValue_1);

var _watch = _interopRequireDefault(watch_1);

var _uniqid = _interopRequireDefault(uniqid_1);

var _dispatch = _interopRequireDefault(dispatch);

var _on = _interopRequireDefault(on);

var _SLitHtmlWebComponent = _interopRequireDefault(SLitHtmlWebComponent);

var _htmlTagToHtmlClassMap = _interopRequireDefault(htmlTagToHtmlClassMap);

var _uncamelize = _interopRequireDefault(uncamelize_1);

var _getHtmlClassFromTagName = _interopRequireDefault(getHtmlClassFromTagName_1);

var _domReady = _interopRequireDefault(domReady_1);

var _getTagNameFromHtmlClass = _interopRequireDefault(getTagNameFromHtmlClass);

var _mediaQuery = _interopRequireDefault(mediaQuery_1);

var _SMediaQuery = _interopRequireDefault(SMediaQuery_1);
...
var SWebComponent$1 = /*@__PURE__*/getDefaultExportFromCjs(SWebComponent);
...
var insertAfter_1 = createCommonjsModule(function (module, exports) {
...
var asyncReplace$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
var asyncAppend$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
var ifDefined$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  ifDefined: ifDefined
});
...
const guard = directive((value, f) => (part) => {
    ...
    if (Array.isArray(value)) {
        ...
        (value !== undefined || previousValues$1.has(part))) {
...
var guard$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  guard: guard
});
...
var styleMap$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  styleMap: styleMap
});
...
var templateContent$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
var unsafeHtml = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
var unsafeSvg = /*#__PURE__*/Object.freeze({
  __proto__: null,
  unsafeSVG: unsafeSVG
});
...
var until$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  until: until
});

var canHaveChildren_1 = createCommonjsModule(function (module, exports) {
...
var SLitHtmlWebComponent = createCommonjsModule(function (module, exports) {
...
var _SWebComponent2 = _interopRequireDefault(SWebComponent);



var _throttle = _interopRequireDefault(throttle_1);

var _insertAfter = _interopRequireDefault(insertAfter_1);
...
var _canHaveChildren = _interopRequireDefault(canHaveChildren_1);
  ...
  return _temp = _class = /*#__PURE__*/function (_SWebComponent) {
    ...
    function SLitHtmlWebComponent(settings) {
      ...
      _defineProperty(_assertThisInitialized(_this), "lit", {
        ...
        asyncReplace: asyncReplace$1.asyncReplace,
        asyncAppend: asyncAppend$1.asyncAppend,
        cache: cache$1.cache,
        classMap: classMap$1.classMap,
        ifDefined: ifDefined$1.ifDefined,
        guard: guard$1.guard,
        repeat: repeat$1.repeat,
        styleMap: styleMap$1.styleMap,
        templateContent: templateContent$1.templateContent,
        unsafeHTML: unsafeHtml.unsafeHTML,
        unsafeSVG: unsafeSvg.unsafeSVG,
        until: until$1.until
      });
    ...
    _createClass(SLitHtmlWebComponent, [{
      ...
      value: function _render() {
        ...
        (0, litHtml.render)(tpl, this.$container);
      }
    }, {
      key: "$root",
      get: function get() {
...
var __SLitHtmlWebComponent = /*@__PURE__*/getDefaultExportFromCjs(SLitHtmlWebComponent);

export { SWebComponent$1 as S, __SLitHtmlWebComponent as _, __clone as a };

...
module.exports = (_temp = _class = /*#__PURE__*/function (_SActionsStreamActio) {
  _inherits(SDocblocksObjectsToMarkdownStreamAction, _SActionsStreamActio);

  var _super = _createSuper(SDocblocksObjectsToMarkdownStreamAction);
   ...
   * @author    Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
   */
  function SDocblocksObjectsToMarkdownStreamAction(settings) {
    if (settings === void 0) {
      settings = {};
    }

    _classCallCheck(this, SDocblocksObjectsToMarkdownStreamAction);
  ...
  _createClass(SDocblocksObjectsToMarkdownStreamAction, [{
    key: "run",
  ...
  return SDocblocksObjectsToMarkdownStreamAction;

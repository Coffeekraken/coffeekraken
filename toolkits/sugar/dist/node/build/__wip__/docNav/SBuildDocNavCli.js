...
module.exports = (_temp = _class = /*#__PURE__*/function (_SCli) {
  _inherits(SBuildDocNavCli, _SCli);

  var _super = _createSuper(SBuildDocNavCli);
   ...
   * @author    Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
   */
  function SBuildDocNavCli(settings) {
    if (settings === void 0) {
      settings = {};
    }

    _classCallCheck(this, SBuildDocNavCli);

    return _super.call(this, settings);
  }

  return SBuildDocNavCli;
}(__SCli), _defineProperty(_class, "command", 'sugar build.docNav %arguments'), _defineProperty(_class, "definitionObj", {
  input: {

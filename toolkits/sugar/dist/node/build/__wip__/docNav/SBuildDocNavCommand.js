...
var __SBuildDocNavCli = require('./SBuildDocNavCli');
...
module.exports = /*#__PURE__*/function (_SCommand) {
  _inherits(SBuildDocNavCommand, _SCommand);

  var _super = _createSuper(SBuildDocNavCommand);
   ...
   * @author 		Olivier Bossel<olivier.bossel@gmail.com>
   */
  function SBuildDocNavCommand(argsObj, commandSettings) {
    if (argsObj === void 0) {
      argsObj = {};
    }
    ...
    _classCallCheck(this, SBuildDocNavCommand);

    // init command
    return _super.call(this, 'build.docNav', new __SBuildDocNavCli(), __deepMerge({
      argsObj,

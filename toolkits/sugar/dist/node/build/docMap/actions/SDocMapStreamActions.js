...
module.exports = (_temp = _class = /*#__PURE__*/function (_SActionsStreamActio) {
  _inherits(SDocMapStreamActions, _SActionsStreamActio);

  var _super = _createSuper(SDocMapStreamActions);
   ...
   * @author    Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
   */
  function SDocMapStreamActions(settings) {
    if (settings === void 0) {
      settings = {};
    }

    _classCallCheck(this, SDocMapStreamActions);
...
}), _defineProperty(_class, "once", true), _temp);
...
module.exports = (_temp = _class = /*#__PURE__*/function (_SCli) {
  _inherits(SBuildJsCli, _SCli);

  var _super = _createSuper(SBuildJsCli);
   ...
   * @author    Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
   */
  function SBuildJsCli(settings) {
    if (settings === void 0) {
      settings = {};
    }

    _classCallCheck(this, SBuildJsCli);
  ...
  return SBuildJsCli;
}(__SCli), _defineProperty(_class, "command", 'sugar build.js %arguments'), _defineProperty(_class, "definitionObj", {
  input: {
    type: 'String',
    alias: 'i',
  ...
  pack: {
    type: 'Boolean|Array',
    alias: 'p',
    description: 'Specify some files to pack using webpack, true to pack all the files or false to simply process them using babel',

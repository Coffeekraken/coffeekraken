...
var __SFrontentServerCli = require('./SFrontendServerCli');
/**
...
module.exports = /*#__PURE__*/function (_SCommand) {
  _inherits(SFrontendServerCommand, _SCommand);

  var _super = _createSuper(SFrontendServerCommand);
   ...
   * @author 		Olivier Bossel<olivier.bossel@gmail.com>
   */
  function SFrontendServerCommand(argsObj, commandSettings) {
    if (argsObj === void 0) {
      argsObj = {};
    }
    ...
    _classCallCheck(this, SFrontendServerCommand);

    // init command
    return _super.call(this, 'server.frontend', new __SFrontentServerCli(), __deepMerge({
      argsObj,

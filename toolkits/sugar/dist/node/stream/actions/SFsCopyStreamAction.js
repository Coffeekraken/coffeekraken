...
module.exports = (_temp = _class = /*#__PURE__*/function (_SActionsStreamActio) {
  _inherits(SFsCopyStreamAction, _SActionsStreamActio);

  var _super = _createSuper(SFsCopyStreamAction);
   ...
   * @author    Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
   */
  function SFsCopyStreamAction(settings) {
    if (settings === void 0) {
      settings = {};
    }

    _classCallCheck(this, SFsCopyStreamAction);
  ...
  _createClass(SFsCopyStreamAction, [{
    key: "run",
    value: function run(streamObj, settings) {
      ...
      return _get(_getPrototypeOf(SFsCopyStreamAction.prototype), "run", this).call(this, streamObj, /*#__PURE__*/function () {

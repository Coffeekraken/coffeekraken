...
module.exports = (_temp = _class = /*#__PURE__*/function (_SActionsStreamActio) {
  _inherits(SFindInFileStreamAction, _SActionsStreamActio);

  var _super = _createSuper(SFindInFileStreamAction);
   ...
   * @author    Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
   */
  function SFindInFileStreamAction(settings) {
    if (settings === void 0) {
      settings = {};
    }

    _classCallCheck(this, SFindInFileStreamAction);
  ...
  return SFindInFileStreamAction;

...
module.exports = (_temp = _class = /*#__PURE__*/function (_SActionsStreamActio) {
  _inherits(SFsReadFileStreamAction, _SActionsStreamActio);

  var _super = _createSuper(SFsReadFileStreamAction);
   ...
   * @author    Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
   */
  function SFsReadFileStreamAction(settings) {
    if (settings === void 0) {
      settings = {};
    }

    _classCallCheck(this, SFsReadFileStreamAction);
  ...
  _createClass(SFsReadFileStreamAction, [{
    key: "run",
  ...
  return SFsReadFileStreamAction;

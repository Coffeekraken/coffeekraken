...
module.exports = (_temp = _class = /*#__PURE__*/function (_SActionsStreamActio) {
  _inherits(SFsUnlinkStreamAction, _SActionsStreamActio);

  var _super = _createSuper(SFsUnlinkStreamAction);
   ...
   * @author    Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
   */
  function SFsUnlinkStreamAction(settings) {
    if (settings === void 0) {
      settings = {};
    }

    _classCallCheck(this, SFsUnlinkStreamAction);
  ...
  _createClass(SFsUnlinkStreamAction, [{
    key: "run",
    value: function run(streamObj, settings) {
      ...
      return _get(_getPrototypeOf(SFsUnlinkStreamAction.prototype), "run", this).call(this, streamObj, async (resolve, reject) => {

...
module.exports = (_temp = _class = /*#__PURE__*/function (_SInterface) {
  _inherits(SValueValidationInterface, _SInterface);

  var _super = _createSuper(SValueValidationInterface);

  function SValueValidationInterface() {
    _classCallCheck(this, SValueValidationInterface);

    return _super.apply(this, arguments);
  }

  return SValueValidationInterface;

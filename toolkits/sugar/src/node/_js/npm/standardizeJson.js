...
var _parseAuthorString = _interopRequireDefault(require("./parseAuthorString"));
...
function standardizeJson(json) {
  ...
  if (json.author && typeof json.author === 'string') {
    json.author = (0, _parseAuthorString.default)(json.author);
  } else if (json.author && Array.isArray(json.author)) {
    json.author = json.author.map(string => {
      if (typeof string === 'string') {
        return (0, _parseAuthorString.default)(string);
      }

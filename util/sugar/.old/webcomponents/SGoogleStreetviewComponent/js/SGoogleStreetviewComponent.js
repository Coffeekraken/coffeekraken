...
export default class SGoogleStreetviewComponent extends mix(SWebComponent).with(
  SGoogleComponentMixin
) {
  /**
  ...
  componentMount() {
    ...
    this._placeholder = this.querySelector(
      `${this._componentNameDash}-placeholder`
    );
  ...
  _handlePlaceholder() {
    ...
    this._placeholder.addEventListener(
      this.props.initOn,
      this._onPlaceholderInit.bind(this)
    );
  }
  ...
  _onPlaceholderInit() {
    ...
    this._placeholder.removeEventListener(
      this.props.initOn,
      this._onPlaceholderInit
    );
    // internal init
    this._internalInit();
  }
   ...
   */
  _initView() {
    this._view = new this._google.maps.StreetViewPanorama(
      this._viewElm,
      this.props
    );
  }
...
sTemplateIntegrator.registerComponentIntegration(
  SGoogleStreetviewComponent,
  component => {

...
var _SCacheAdapter = _interopRequireDefault(require("./SCacheAdapter"));
 ...
 */
class SCacheLsAdapter extends _SCacheAdapter.default {
  /**
   * @name                              constructor
   * @type                              Function
   * 
  ...
  constructor(settings = {}) {
    super((0, _deepMerge.default)({}, settings));
  }
  /**
   * @name                          set
   * @type                          Function

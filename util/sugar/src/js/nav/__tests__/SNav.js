module.exports = (__SNav, __SNavItem) => {
  describe('sugar.js.nav.SNav', () => {
    it('Should create and update a nav correctly', (done) => {
      ...
      const nav = new __SNav(
        'myCoolNav',
        'My Cool Nav',
        [navItem, otherNav, navItem2],
        {}
      );

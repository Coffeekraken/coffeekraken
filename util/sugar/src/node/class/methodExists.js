 ...
 * @param           {String|Array}        methods                 The methods to check
 ...
 *    hello() {}
 * }
 * const methodExists = require('@coffeekraken/sugar/node/class/methodExists');
 * const myInstance = new Coco();
 * methodExists(myInstance, ['hello','world']); // => ['world'];
 * 
 * @author 		Olivier Bossel <olivier.bossel@gmail.com> (https://olivierbossel.com)
 */
module.exports = function methodExists(instance, methods) {

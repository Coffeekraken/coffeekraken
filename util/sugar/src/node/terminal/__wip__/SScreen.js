...
module.exports = class STerminalScreen extends __blessed.screen {
  ...
  constructor(settings = {}) {
    ...
    this._box = __blessed.box({
      top: (typeof settings.padding === 'object') ? settings.padding.top || 3 : settings.padding,
      bottom: (typeof settings.padding === 'object') ? settings.padding.bottom || 3 : settings.padding,
      left: (typeof settings.padding === 'object') ? settings.padding.left || 3 : settings.padding,
      right: (typeof settings.padding === 'object') ? settings.padding.right || 3 : settings.padding,
    });

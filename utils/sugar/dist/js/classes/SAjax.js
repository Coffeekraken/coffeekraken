...
var _SObject = _interopRequireDefault(require("../core/SObject"));

var _simpleAjax = _interopRequireDefault(require("simple-ajax"));

var _Observable = require("rxjs/Observable");

var _strToHtml = _interopRequireDefault(require("../utils/strings/strToHtml"));

var _htmlToStr = _interopRequireDefault(require("../utils/strings/htmlToStr"));
...
class SAjax extends _SObject.default {
  ...
  constructor(request, settings = {}) {
    ...
    _defineProperty(this, "_simpleAjax", null);

...
var SAjax = (function(_SObject) {
  ...
  function SAjax(request) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (SAjax.__proto__ || Object.getPrototypeOf(SAjax)).call(this)
    );
  ...
  _createClass(SAjax, [
    {
      ...
      value: function _createRequest() {
        ...
        if (this._settings.beforeSend) {
          this._requestSetting = this._settings.beforeSend(
        ...
        if (
          this._requestSettings.method.toLowerCase() === "get" &&
        ...
        var simpleAjax = new _simpleAjax2.default(
          _extends({}, this._requestSettings, {
        ...
        simpleAjax.on("success", function(e) {
          ...
          var contentType = simpleAjax.request.getResponseHeader(
            "content-type"
          );
          ...
          switch (true) {
            case contentType.indexOf("text/html") === 0:
              ...
              var urlParts = simpleAjax._requestSettings.url
                .toString()
                .split(/#|%23/);
              if (
                urlParts.length >= 2 &&
          ...
          if (_this2._settings.cache) {
            ...
            _this2._settings.cache.set(
              simpleAjax._requestSettings.url,
              response
            );
          }
        ...
        simpleAjax.on("complete", function(e) {
          ...
          if (_this2._settings.sendInterval) {
            // handle sendCount
            if (
              _this2._settings.sendCount &&
              _this2._requestsCount >= _this2._settings.sendCount
            ) {
              // notify subscriber
              if (_this2._observer) {
      ...
      value: function send() {
        ...
        return new Promise(function(resolve, reject) {
          ...
          if (_this3._settings.cache) {
            var response = _this3._settings.cache.get(
              _this3._requestSettings.url
            );
            if (response) {
              resolve(response);
              return;

  ...
  _createClass(SBinder, [
    {
      ...
      value: function bindObjectPath2ObjectPath(
        object1,
        path1,
        object2,
        path2
    ...
    },
    {
      ...
      value: function bindElementAttribute2ObjectPath(
        elm,
        attribute,
        object,
        path
        ...
        if (!object._binderId)
          object._binderId = "s-binder-" + (0, _uniqid2.default)();
    ...
    },
    {
      ...
      value: function bindObjectPath2ElementAttribute(
        object,
        path,
        elm,
        attribute
        ...
        this._watcher.watch(object, path, function(newVal, oldVal) {
          ...
          for (var _attribute in _this._bindStack.obj2attr[
            object._binderId + ":" + path
          ]) {
            var watch =
              _this._bindStack.obj2attr[object._binderId + ":" + path][
                _attribute
              ];
            ...
            watch.elm.setAttribute(
              (0, _uncamelize2.default)(watch.attribute),
              newVal
            );
      ...
      value: function _observeDomElement(elm) {
        ...
        var observer = new MutationObserver(function(mutations) {
          ...
          mutations.forEach(function(mutation) {
            ...
            var val = (0, _autoCast2.default)(
              elm.getAttribute(mutation.attributeName)
            );
            ...
            if (_this2._bindStack.attr2obj[mutation.attributeName]) {
              ...
              for (var objectPath in _this2._bindStack.attr2obj[
                mutation.attributeName
              ]) {
                var watch =
                  _this2._bindStack.attr2obj[mutation.attributeName][
                    objectPath
                  ];

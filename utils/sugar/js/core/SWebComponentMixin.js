      ...
      },
      {
        ...
        value: function connectedCallback() {
          ...
          this._whenMountDependenciesAreOk().then(function() {
            ...
            if (
              _this3.props.mountWhen &&
              typeof _this3.props.mountWhen === "function"
            ) {
              _this3.props
                .mountWhen()
                .then(function() {
              ...
              _this3.props.mountWhen &&
              typeof _this3.props.mountWhen === "string"
            ) {
      ...
      },
      {
        ...
        value: function _onMouseoverComponentMount() {
          ...
          this.removeEventListener(
            "mouseover",
            this._onMouseoverComponentMount
          );
        }
          ...
          this._fastdomSetProp = _fastdom2.default.mutate(function() {
            ...
            if (
              ...
              !_this7.shouldComponentUpdate(
                ...
                _this7._nextStateStack,
                _this7._prevStateStack
              )
            )
              return;
      ...
      },
      {
        ...
        value: function _handleNewStateValue(prop, newVal, oldVal) {
          ...
          this._fastDomNewStateTimeout = _fastdom2.default.mutate(function() {
            // should component update
            if (
              _this8.shouldComponentUpdate &&
              !_this8.shouldComponentUpdate(
                _this8._nextPropsStack,
                _this8._prevPropsStack,
                _this8._nextStateStack,
                _this8._prevStateStack
              )
            )
              return;

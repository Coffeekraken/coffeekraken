...
function getAnimationProperties(elm) {
  ...
  var duration =
    (0, _getStyleProperty2.default)(elm, "animation-duration") || "0s";
  var timingFunction =
    (0, _getStyleProperty2.default)(elm, "animation-timing-function") ||
    "linear";
  var delay = (0, _getStyleProperty2.default)(elm, "animation-delay") || "0s";
  var iterationCount =
    (0, _getStyleProperty2.default)(elm, "animation-iteration-count") || 1;
  var direction =
    (0, _getStyleProperty2.default)(elm, "animation-direction") || "normal";

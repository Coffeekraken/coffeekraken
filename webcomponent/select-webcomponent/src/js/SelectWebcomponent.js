...
import SEvent from "@coffeekraken/sugar/js/class/SEvent";
...
import "@coffeekraken/sugar/js/polyfill/queryselector-scope";
import "@coffeekraken/sugar/js/rxjs/operator/groupByTimeout";
...
export default class SelectWebcomponent extends native(HTMLSelectElement) {
  /**
   * Default css
   *
  ...
  _handleOptionClick(_s_option, e) {
    ...
    if (!this.isMultiple()) {
      ...
      _s_option._ck_select_source_option.selected = !_s_option
        ._ck_select_source_option.selected;

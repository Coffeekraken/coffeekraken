...
/***/ "../../util/sugar/src/js/dom/getStyleProperty.js":
/*!*********************************************************************************************************!*\
  !*** /Users/olivierbossel/data/web/coffeekraken/coffeekraken/util/sugar/src/js/dom/getStyleProperty.js ***!
  \*********************************************************************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getStyleProperty; });
/* harmony import */ var _string_camelize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../string/camelize */ "../../util/sugar/src/js/string/camelize.js");
/* harmony import */ var _string_autoCast__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../string/autoCast */ "../../util/sugar/src/js/string/autoCast.js");
...
function getStyleProperty(elm, property) {
  ...
  for (var i = 0; i < prefixes.length; i++) {
    ...
    var value = computed[Object(_string_camelize__WEBPACK_IMPORTED_MODULE_0__["default"])("".concat(prefix).concat(property))];
    if (value && value.trim() !== "") return Object(_string_autoCast__WEBPACK_IMPORTED_MODULE_1__["default"])(value);
  }
...
/***/ "../../util/sugar/src/js/dom/getTransitionProperties.js":
/*!****************************************************************************************************************!*\
  !*** /Users/olivierbossel/data/web/coffeekraken/coffeekraken/util/sugar/src/js/dom/getTransitionProperties.js ***!
  \****************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getTransitionProperties; });
/* harmony import */ var _getStyleProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getStyleProperty */ "../../util/sugar/src/js/dom/getStyleProperty.js");
/* harmony import */ var _time_convert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../time/convert */ "../../util/sugar/src/js/time/convert.js");
...
function getTransitionProperties(elm) {
  ...
  var property = Object(_getStyleProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(elm, 'transition-property');

  var duration = Object(_getStyleProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(elm, 'transition-duration') || 0;

  var timingFunction = Object(_getStyleProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(elm, 'transition-timing-function');

  var delay = Object(_getStyleProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(elm, 'transition-delay'); // return the transition object


  var props = {
    property: splitIfNeeded(property, ','),
    duration: splitIfNeeded(duration, ',').map(function (value) {
      return Object(_time_convert__WEBPACK_IMPORTED_MODULE_1__["default"])(value, 'ms');
    }),
...
/***/ "../../util/sugar/src/js/dom/whenTransitionEnd.js":
/*!**********************************************************************************************************!*\
  !*** /Users/olivierbossel/data/web/coffeekraken/coffeekraken/util/sugar/src/js/dom/whenTransitionEnd.js ***!
  \**********************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return whenTransitionEnd; });
/* harmony import */ var _getTransitionProperties__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getTransitionProperties */ "../../util/sugar/src/js/dom/getTransitionProperties.js");
...
function whenTransitionEnd(elm) {
  ...
  return new Promise(function (resolve, reject) {
    var transition = Object(_getTransitionProperties__WEBPACK_IMPORTED_MODULE_0__["default"])(elm);
...
/***/ "../../util/sugar/src/js/time/convert.js":
/*!*************************************************************************************************!*\
  !*** /Users/olivierbossel/data/web/coffeekraken/coffeekraken/util/sugar/src/js/time/convert.js ***!
  \*************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
